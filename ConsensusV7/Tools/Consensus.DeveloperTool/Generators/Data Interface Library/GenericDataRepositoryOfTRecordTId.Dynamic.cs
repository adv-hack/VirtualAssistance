...
namespace Consensus.CodeGenerator
{
    ...
    /// </summary>
    public class GenericDataRepositoryOfTRecordTIdDynamic : GeneratedInterface
    {
        #region properties
        ...
        /// </param>
        public GenericDataRepositoryOfTRecordTIdDynamic(GeneratedProject project) : base(project)
        {
        }
