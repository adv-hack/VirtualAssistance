...
{
    /// <summary>
    ///     Generates the dynamic-code file for the record base class.
    /// </summary>
    public class GenericDataRecordDynamic : GeneratedClass
    {
        #region properties
        ...
        /// </param>
        public GenericDataRecordDynamic(GeneratedProject project) : base(project)
        {
        }
