...
{
    /// <summary>
    ///     Generates the dynamic-code file for the repository interface.
    /// </summary>
    public class GenericDataRepositoryDynamic : GeneratedInterface
    {
        #region properties
        ...
        /// </param>
        public GenericDataRepositoryDynamic(GeneratedProject project) : base(project)
        {
        }
