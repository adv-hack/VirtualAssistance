...
{
    /// <summary>
    ///     Generates the dynamic-code file for the repository collection interface.
    /// </summary>
    public class GenericDataRepositoryCollectionDynamic : GeneratedInterface
    {
        #region properties
        ...
        {
            get { return "IRepositoryCollection"; }
        }
        ...
        /// </param>
        public GenericDataRepositoryCollectionDynamic(GeneratedProject project) : base(project)
        {
        }
