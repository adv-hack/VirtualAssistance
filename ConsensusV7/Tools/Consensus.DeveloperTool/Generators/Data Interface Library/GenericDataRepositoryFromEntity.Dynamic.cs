...
namespace Consensus.CodeGenerator
{
    ...
    /// </summary>
    public class GenericDataRepositoryFromEntityDynamic : GeneratedInterface
    {
        #region fields
        ...
        {
            get { return "Provides the persistence and retrieval of the <see cref=\"" + this.Entity.ReferencedTable.ProgrammaticName + "Record\" /> instances"; }
        }
        ...
        {
            get { return "I" + this.Entity.EntityName + "Repository"; }
        }
        ...
        public override IEnumerable<String> TypeInterfaces
        {
            get
            {
                yield return "IRepository<" + this.Entity.ReferencedTable.ProgrammaticName + "Record, " + this.Entity.ReferencedTable.TableKey.ProgrammaticType + ">";
            }
        }
        ...
        /// <summary>
        ///     Initialises a new <see cref="GenericDataRepositoryFromEntityDynamic" /> instance.
        /// </summary>
        /// <param name="project">
        ...
        /// </param>
        public GenericDataRepositoryFromEntityDynamic(GeneratedProject project, DomainEntity entity) : base(project)
        {
            _entity = entity;
        }
