...
{
    public class GenericBusinessProviderDynamic : GeneratedInterface
    {
        #region fields
        ...
        {
            get { return "Supports the programmatic access to the factory collections."; }
        }
        ...
        /// <summary>
        ///     Gets whether an existing file will be edited.
        /// </summary>
        ...
        /// <summary>
        ///     Initialises a new <see cref="GenericBusinessProviderDynamic" /> instance.
        /// </summary>
        /// <param name="project">
        ///     Sets the project, in which this runtime type is included.
        /// </param>
        public GenericBusinessProviderDynamic(GeneratedProject project, DomainContainer[] containers) : base(project)
        {
