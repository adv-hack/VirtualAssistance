...
{
    public class GenericBusinessFactoryOfTModelDynamic : GeneratedInterface
    {
        #region fields
        ...
        public override IEnumerable<CSharpGeneric> TypeGenerics
        {
            get
            {
                yield return new CSharpGeneric()
                {
                    ...
                    GenericName = "TModel",
                    GenericConstraints = new String[] { "IModel" }
                };
            }
        }
        ...
        /// </param>
        public GenericBusinessFactoryOfTModelDynamic(GeneratedProject project, Domain domain) : base(project)
        {
            _domain = domain;
        }
