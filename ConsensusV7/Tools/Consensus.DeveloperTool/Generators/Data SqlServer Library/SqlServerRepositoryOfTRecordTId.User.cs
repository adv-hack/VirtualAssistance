...
{ 
    /// <summary>
    ///     Generates the user-code file for the generic-typed repository base class.
    /// </summary>
    public class SqlServerRepositoryOfTRecordTIdUser : GeneratedClass
    {
        #region properties
        ...
        /// <summary>
        ///     Initialises a new <see cref="SqlServerRepositoryOfTRecordTIdUser" /> instance.
        /// </summary>
        /// <param name="project">
        ...
        /// </param>
        public SqlServerRepositoryOfTRecordTIdUser(GeneratedProject project) : base(project)
        {
        }
