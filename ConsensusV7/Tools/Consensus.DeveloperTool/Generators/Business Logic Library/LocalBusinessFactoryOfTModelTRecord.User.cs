...
{
    public class LocalBusinessFactoryOfTModelTRecordUser : GeneratedClass
    {
        #region properties
        ...
        /// </param>
        public LocalBusinessFactoryOfTModelTRecordUser(GeneratedProject project) : base(project)
        {
        }
