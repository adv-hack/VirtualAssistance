...
{
    public class LocalBusinessFactoryOfTModelTRecordTIdDynamic : GeneratedClass
    {
        #region properties
        ...
        public override IEnumerable<CSharpGeneric> TypeGenerics
        {
            get
            {
                yield return new CSharpGeneric()
                {
                    ...
                    GenericConstraints = new String[] { "LocalModel<TRecord, TId>" }
                };
                yield return new CSharpGeneric()
                {
                    GenericName = "TRecord",
        ...
        {
            get { return "LocalFactory<TModel, TRecord>"; }
        }
        ...
        {
            get { yield return "IFactory<TModel, TId>"; }
        }
        ...
        /// </param>
        public LocalBusinessFactoryOfTModelTRecordTIdDynamic(GeneratedProject project) : base(project)
        {
        }
