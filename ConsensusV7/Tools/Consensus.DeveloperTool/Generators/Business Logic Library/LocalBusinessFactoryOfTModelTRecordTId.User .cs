...
{
    public class LocalBusinessFactoryOfTModelTRecordTIdUser : GeneratedClass
    {
        #region properties
        ...
        /// <summary>
        ///     Initialises a new <see cref="LocalBusinessFactoryCollectionUser" /> instance.
        /// </summary>
        /// <param name="project">
        ...
        /// </param>
        public LocalBusinessFactoryOfTModelTRecordTIdUser(GeneratedProject project) : base(project)
        {
        }
