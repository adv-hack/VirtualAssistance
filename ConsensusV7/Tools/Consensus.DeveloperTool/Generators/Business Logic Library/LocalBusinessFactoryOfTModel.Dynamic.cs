...
{
    public class LocalBusinessFactoryOfTModelDynamic : GeneratedClass
    {
        #region properties
        ...
        public override IEnumerable<CSharpGeneric> TypeGenerics
        {
            get
            {
                yield return new CSharpGeneric()
                {
                    ...
                    GenericConstraints = new String[] { "LocalModel" }
                };
            }
        }
        ...
        {
            get { yield return "IFactory<TModel>"; }
        }
        ...
        /// </param>
        public LocalBusinessFactoryOfTModelDynamic(GeneratedProject project) : base(project)
        {
        }
