...
{
    public class LocalBusinessModelFromEntityUser : GeneratedClass
    {
        #region fields
        ...
        {
            get { return this.Entity.EntityName + ".model"; }
        }
        ...
        /// </param>
        public LocalBusinessModelFromEntityUser(GeneratedProject project, DomainEntity entity) : base(project)
        {
            _entity = entity;
        }
