...
namespace Consensus
{
    ...
    public static class Conversion
    {
        ...
        /// <summary>
        ///     The method nodeName used to identify custom conversion methods defined in the Conversion class
        /// </summary>
        ...
        /// <summary>
        ///     The method nodeName used to identify generic conversion methods
        /// </summary>
        ...
        public static Object ConvertTo(this Object value, Type type)
        {
            ...
            return ConvertTo(value, type, defaultValue);
        }
        ...
        public static Object ConvertTo(this Object value, Type type, Object defaultValue)
        {
            ...
            // Identify the conversion method, matched by nodeName
        ...
        {
            return Conversion.ConvertTo<T>(value, default(T));
        }
        ...
        public static T ConvertTo<T>(this Object value, T defaultValue)
        {
            ...
            // If conversion can be achieved dynamically, using reflection to execute a standard Microsoft.NET method, perform the conversion and return the result of the conversion
            else if (Conversion.AttemptReflectiveConversion<T>(value, out parsedValue))
            {
                returnValue = parsedValue;
            }
            ...
            else if (typeof(T) == typeof(String))
            {
                if (value is Enum)
                    ...
                    returnValue = (T)(Object)((Int16)value).ToString("0");
                else if (value is Int32)
                    returnValue = (T)(Object)((Int32)value).ToString("0");
                else if (value is Int64)
                    returnValue = (T)(Object)((Int64)value).ToString("0");
                else if (value is UInt16)
                    returnValue = (T)(Object)((UInt16)value).ToString("0");
                else if (value is UInt32)
                    returnValue = (T)(Object)((UInt32)value).ToString("0");
                else if (value is UInt64)
                    returnValue = (T)(Object)((UInt64)value).ToString("0");
                    ...
                    returnValue = (T)(Object)((DateTime)value).ToString("dd MMM yyyy");
            ...
            else if (value.GetType() == typeof(Decimal) || value.GetType() == typeof(Double) || value.GetType() == typeof(Single) || value.GetType() == typeof(SByte) || value.GetType() == typeof(Int16) || value.GetType() == typeof(Int32) || value.GetType() == typeof(Int64) || value.GetType() == typeof(Byte) || value.GetType() == typeof(UInt16) || value.GetType() == typeof(UInt32) || value.GetType() == typeof(UInt64))
            {
                if (absoluteType == typeof(Int16))
                {
                    try { returnValue = (T)(Object)Convert.ToInt16(value); }
                    catch { returnValue = defaultValue; }
                }
                else if (absoluteType ==typeof(Int32))
                {
                    try { returnValue = (T)(Object)Convert.ToInt32(value); }
                    catch { returnValue = defaultValue; }
                }
                else if (absoluteType ==typeof(Int64))
                {
                    try { returnValue = (T)(Object)Convert.ToInt64(value); }
                    catch { returnValue = defaultValue; }
                }
                else if (absoluteType ==typeof(UInt16))
                {
                    try { returnValue = (T)(Object)Convert.ToUInt16(value); }
                    catch { returnValue = defaultValue; }
                }
                else if (absoluteType ==typeof(UInt32))
                {
                    try { returnValue = (T)(Object)Convert.ToUInt32(value); }
                    catch { returnValue = defaultValue; }
                }
                else if (absoluteType == typeof(UInt64))
                {
                    try { returnValue = (T)(Object)Convert.ToUInt64(value); }
                    catch { returnValue = defaultValue; }
                }
                else if (absoluteType == typeof(Decimal))
                {
                    try { returnValue = (T)(Object)Convert.ToDecimal(value); }
                    catch { returnValue = defaultValue; }
                }
                else if (absoluteType == typeof(Double))
                {
                    try { returnValue = (T)(Object)Convert.ToDouble(value); }
                    catch { returnValue = defaultValue; }
                }
                else if (absoluteType == typeof(Single))
                {
        ...
        ///     A <see cref="T:System.Boolean" /> value which indicates if conversion succeeded
        /// </returns>
        private static Boolean AttemptReflectiveConversion<T>(Object value, out T result)
        {
            Boolean success;
            ...
            {
                Type[] parameterTypes = { value.GetType(), typeof(T).MakeByRefType() };
                Object[] parameterValues = { value, null };
                MethodInfo method = typeof(T).GetMethod("TryParse", BindingFlags.Public | BindingFlags.Static, null, parameterTypes, null);
                if (method == null)
                {
                    // Conversion failed, no TryParse method could be found
                    result = default(T);
                    success = false;
                }
                else if (Object.Equals(method.Invoke(null, parameterValues), false))
                {
                    // Conversion failed, TryParse method returned false
                    result = default(T);
                    success = false;
                }
                else
                {
                    result = (T)parameterValues[1];
                    success = true;
                }
            }
            return success;
        ...
        private static Boolean AttemptEnumeratorConversion<T>(Object value, out T result)
        {
            ...
            else if (value is String)
            {
                ...
                foreach (String stringValue in stringValueCollection)
                {
                    ...
                    IEnumerable<T> enumeration = Enum.GetValues(typeof(T)).OfType<T>().Where(enumValue => String.Equals(stringValue, Enum.GetName(typeof(T), enumValue), StringComparison.OrdinalIgnoreCase));
                ...
                if (success)
                    result = (T)Convert.ChangeType(checkedValue, Enum.GetUnderlyingType(typeof(T)));
                else
                    result = default(T);
            }
            else if (value is Byte || value is SByte || value is Int16 || value is UInt16 || value is Int32 || value is UInt32 || value is Int64 || value is UInt64)
            {
                ...
                foreach (Object enumeration in Enum.GetValues(typeof(T)))
                {
