...
{
    /// <summary>
    ///     Generates the generically-typed record abstract class.
    /// </summary>
    public class GeneratedRecordOfTKey : TypeClass
    {
        /// <summary>
        ...
        {
            get { return "Represents a data structure within the persistence mechanism, which is distinctly identifiable by a unique key."; }
        }
        ...
        public override IEnumerable<MemberGeneric> TypeGenerics
        {
            get
            {
                ...
                {
                    MemberName = "TKey",
                    XmlSummary = "The data type of the unique key which distinctly identifies the instance of the data structure."
                };
            }
        }
        ...
        public override IEnumerable<Member> Members
        {
            get
            {
                yield return new MemberField(this)
                {
                    ...
                    MemberType = "TKey",
                    MemberName = "Id",
                    XmlSummary = "The unique key which distinctly identifies the instance of the data structure."
                };
            }
        }
    }
