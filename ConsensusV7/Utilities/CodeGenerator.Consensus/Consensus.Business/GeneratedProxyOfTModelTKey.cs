...
namespace CodeGenerator.Consensus.Business
{
    ...
    /// </summary>
    public class GeneratedProxyOfTModelTKey : TypeClass
    {
        /// <summary>
        ...
        public override IEnumerable<Member> Members
        {
            get
            {
                yield return new MemberProperty(this)
                {
                    ...
                    MemberType = "TKey",
                    MemberName = "Id",
                    GetAccessor = new MemberAccessor() { Modifier = CSharpModifier.Public, Code = new String[] { "return base.Model.Id;" } }
                };
