...
namespace Consensus.Finance
{
    ...
    /// </remarks>
    public partial class PaymentBacs : Proxy<IPaymentBacsModel, String>
    {
        #region fields
        ...
        /// </summary>
        internal PaymentBacs(IPaymentBacsModel model) : base(model)
        {
        }
        ...
        /// </returns>
        public static Consensus.Finance.PaymentBacs Create()
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.Create(site);
        }
        ...
        ///     A newly instantiated <see cref="!:PaymentBacsModel" /> instance.
        /// </returns>
        public static Consensus.Finance.PaymentBacs Create(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            Consensus.Finance.IPaymentBacsModel model = provider.Finance.PaymentBacs.Create();
            return model == null ? null : new Consensus.Finance.PaymentBacs(model);
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAll()
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchAll(site);
        }
        ...
        ///     An enumerable collection of <see cref="!:PaymentBacsModel" /> instances.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAll(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentBacsModel> collection = provider.Finance.PaymentBacs.FetchAll();
            return collection.Select(model => new Consensus.Finance.PaymentBacs(model));
        }
        ...
        /// </returns>
        public static Consensus.Finance.PaymentBacs FetchById(System.String id)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchById(site,id);
        }
        ...
        ///     The <see cref="!:PaymentBacsModel" /> instance that matches the specified <paramref name="id" />; or null, if no matching instance can be found.
        /// </returns>
        public static Consensus.Finance.PaymentBacs FetchById(ConsensusSite site, System.String id)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            Consensus.Finance.IPaymentBacsModel model = provider.Finance.PaymentBacs.FetchById(id);
            return model == null ? null : new Consensus.Finance.PaymentBacs(model);
        }
        ...
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.GetTableName(site);
        }

        public static System.String GetTableName(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            return provider.Finance.PaymentBacs.GetTableName();
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllBySellingCompanyId(System.String sellingCompanyId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchAllBySellingCompanyId(site,sellingCompanyId);
        }
        ...
        ///     The <see cref="!:PaymentBacsModel" /> instances that match the specified <paramref name="sellingCompanyId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllBySellingCompanyId(ConsensusSite site, System.String sellingCompanyId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentBacsModel> collection = provider.Finance.PaymentBacs.FetchAllBySellingCompanyId(sellingCompanyId);
            return collection.Select(model => new Consensus.Finance.PaymentBacs(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByMemberPeriodId(System.String memberPeriodId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchAllByMemberPeriodId(site,memberPeriodId);
        }
        ...
        ///     The <see cref="!:PaymentBacsModel" /> instances that match the specified <paramref name="memberPeriodId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByMemberPeriodId(ConsensusSite site, System.String memberPeriodId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentBacsModel> collection = provider.Finance.PaymentBacs.FetchAllByMemberPeriodId(memberPeriodId);
            return collection.Select(model => new Consensus.Finance.PaymentBacs(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByOrganisationId(System.String organisationId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchAllByOrganisationId(site,organisationId);
        }
        ...
        ///     The <see cref="!:PaymentBacsModel" /> instances that match the specified <paramref name="organisationId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByOrganisationId(ConsensusSite site, System.String organisationId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentBacsModel> collection = provider.Finance.PaymentBacs.FetchAllByOrganisationId(organisationId);
            return collection.Select(model => new Consensus.Finance.PaymentBacs(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByPersonId(System.String personId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchAllByPersonId(site,personId);
        }
        ...
        ///     The <see cref="!:PaymentBacsModel" /> instances that match the specified <paramref name="personId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByPersonId(ConsensusSite site, System.String personId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentBacsModel> collection = provider.Finance.PaymentBacs.FetchAllByPersonId(personId);
            return collection.Select(model => new Consensus.Finance.PaymentBacs(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByBookingId(System.String bookingId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchAllByBookingId(site,bookingId);
        }
        ...
        ///     The <see cref="!:PaymentBacsModel" /> instances that match the specified <paramref name="bookingId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByBookingId(ConsensusSite site, System.String bookingId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentBacsModel> collection = provider.Finance.PaymentBacs.FetchAllByBookingId(bookingId);
            return collection.Select(model => new Consensus.Finance.PaymentBacs(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByRefundId(System.String refundId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchAllByRefundId(site,refundId);
        }
        ...
        ///     The <see cref="!:PaymentBacsModel" /> instances that match the specified <paramref name="refundId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByRefundId(ConsensusSite site, System.String refundId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentBacsModel> collection = provider.Finance.PaymentBacs.FetchAllByRefundId(refundId);
            return collection.Select(model => new Consensus.Finance.PaymentBacs(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByAddressId(System.String addressId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchAllByAddressId(site,addressId);
        }
        ...
        ///     The <see cref="!:PaymentBacsModel" /> instances that match the specified <paramref name="addressId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByAddressId(ConsensusSite site, System.String addressId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentBacsModel> collection = provider.Finance.PaymentBacs.FetchAllByAddressId(addressId);
            return collection.Select(model => new Consensus.Finance.PaymentBacs(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByAccountId(System.String accountId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchAllByAccountId(site,accountId);
        }
        ...
        ///     The <see cref="!:PaymentBacsModel" /> instances that match the specified <paramref name="accountId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByAccountId(ConsensusSite site, System.String accountId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentBacsModel> collection = provider.Finance.PaymentBacs.FetchAllByAccountId(accountId);
            return collection.Select(model => new Consensus.Finance.PaymentBacs(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByLetterTemplateId(System.String letterTemplateId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchAllByLetterTemplateId(site,letterTemplateId);
        }
        ...
        ///     The <see cref="!:PaymentBacsModel" /> instances that match the specified <paramref name="letterTemplateId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByLetterTemplateId(ConsensusSite site, System.String letterTemplateId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentBacsModel> collection = provider.Finance.PaymentBacs.FetchAllByLetterTemplateId(letterTemplateId);
            return collection.Select(model => new Consensus.Finance.PaymentBacs(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByCardholderRoleId(System.String cardholderRoleId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentBacs.FetchAllByCardholderRoleId(site,cardholderRoleId);
        }
        ...
        ///     The <see cref="!:PaymentBacsModel" /> instances that match the specified <paramref name="cardholderRoleId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentBacs> FetchAllByCardholderRoleId(ConsensusSite site, System.String cardholderRoleId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentBacsModel> collection = provider.Finance.PaymentBacs.FetchAllByCardholderRoleId(cardholderRoleId);
            return collection.Select(model => new Consensus.Finance.PaymentBacs(model));
        }
