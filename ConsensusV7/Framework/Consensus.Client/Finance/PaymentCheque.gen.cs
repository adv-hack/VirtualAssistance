...
namespace Consensus.Finance
{
    ...
    /// </remarks>
    public partial class PaymentCheque : Proxy<IPaymentChequeModel, String>
    {
        #region fields
        ...
        /// </summary>
        internal PaymentCheque(IPaymentChequeModel model) : base(model)
        {
        }
        ...
        ///     A newly instantiated <see cref="!:PaymentChequeModel" /> instance.
        /// </returns>
        public static Consensus.Finance.PaymentCheque Create(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            Consensus.Finance.IPaymentChequeModel model = provider.Finance.PaymentCheque.Create();
            return model == null ? null : new Consensus.Finance.PaymentCheque(model);
        }
        ...
        ///     An enumerable collection of <see cref="!:PaymentChequeModel" /> instances.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAll(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentChequeModel> collection = provider.Finance.PaymentCheque.FetchAll();
        ...
        ///     The <see cref="!:PaymentChequeModel" /> instance that matches the specified <paramref name="id" />; or null, if no matching instance can be found.
        /// </returns>
        public static Consensus.Finance.PaymentCheque FetchById(ConsensusSite site, System.String id)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            Consensus.Finance.IPaymentChequeModel model = provider.Finance.PaymentCheque.FetchById(id);
            return model == null ? null : new Consensus.Finance.PaymentCheque(model);
        }
        ...
        ///     The <see cref="!:PaymentChequeModel" /> instances that match the specified <paramref name="sellingCompanyId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllBySellingCompanyId(ConsensusSite site, System.String sellingCompanyId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentChequeModel> collection = provider.Finance.PaymentCheque.FetchAllBySellingCompanyId(sellingCompanyId);
            return collection.Select(model => new Consensus.Finance.PaymentCheque(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByMemberPeriodId(System.String memberPeriodId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentCheque.FetchAllByMemberPeriodId(site,memberPeriodId);
        }
        ...
        ///     The <see cref="!:PaymentChequeModel" /> instances that match the specified <paramref name="memberPeriodId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByMemberPeriodId(ConsensusSite site, System.String memberPeriodId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentChequeModel> collection = provider.Finance.PaymentCheque.FetchAllByMemberPeriodId(memberPeriodId);
            return collection.Select(model => new Consensus.Finance.PaymentCheque(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByOrganisationId(System.String organisationId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentCheque.FetchAllByOrganisationId(site,organisationId);
        }
        ...
        ///     The <see cref="!:PaymentChequeModel" /> instances that match the specified <paramref name="organisationId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByOrganisationId(ConsensusSite site, System.String organisationId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentChequeModel> collection = provider.Finance.PaymentCheque.FetchAllByOrganisationId(organisationId);
            return collection.Select(model => new Consensus.Finance.PaymentCheque(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByPersonId(System.String personId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentCheque.FetchAllByPersonId(site,personId);
        }
        ...
        ///     The <see cref="!:PaymentChequeModel" /> instances that match the specified <paramref name="personId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByPersonId(ConsensusSite site, System.String personId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentChequeModel> collection = provider.Finance.PaymentCheque.FetchAllByPersonId(personId);
            return collection.Select(model => new Consensus.Finance.PaymentCheque(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByBookingId(System.String bookingId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentCheque.FetchAllByBookingId(site,bookingId);
        }
        ...
        ///     The <see cref="!:PaymentChequeModel" /> instances that match the specified <paramref name="bookingId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByBookingId(ConsensusSite site, System.String bookingId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentChequeModel> collection = provider.Finance.PaymentCheque.FetchAllByBookingId(bookingId);
            return collection.Select(model => new Consensus.Finance.PaymentCheque(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByRefundId(System.String refundId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentCheque.FetchAllByRefundId(site,refundId);
        }
        ...
        ///     The <see cref="!:PaymentChequeModel" /> instances that match the specified <paramref name="refundId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByRefundId(ConsensusSite site, System.String refundId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentChequeModel> collection = provider.Finance.PaymentCheque.FetchAllByRefundId(refundId);
            return collection.Select(model => new Consensus.Finance.PaymentCheque(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByAddressId(System.String addressId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentCheque.FetchAllByAddressId(site,addressId);
        }
        ...
        ///     The <see cref="!:PaymentChequeModel" /> instances that match the specified <paramref name="addressId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByAddressId(ConsensusSite site, System.String addressId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentChequeModel> collection = provider.Finance.PaymentCheque.FetchAllByAddressId(addressId);
            return collection.Select(model => new Consensus.Finance.PaymentCheque(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByAccountId(System.String accountId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return PaymentCheque.FetchAllByAccountId(site,accountId);
        }
        ...
        ///     The <see cref="!:PaymentChequeModel" /> instances that match the specified <paramref name="accountId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByAccountId(ConsensusSite site, System.String accountId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentChequeModel> collection = provider.Finance.PaymentCheque.FetchAllByAccountId(accountId);
            return collection.Select(model => new Consensus.Finance.PaymentCheque(model));
        }
        ...
        ///     The <see cref="!:PaymentChequeModel" /> instances that match the specified <paramref name="letterTemplateId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.PaymentCheque> FetchAllByLetterTemplateId(ConsensusSite site, System.String letterTemplateId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentChequeModel> collection = provider.Finance.PaymentCheque.FetchAllByLetterTemplateId(letterTemplateId);
            return collection.Select(model => new Consensus.Finance.PaymentCheque(model));
        }
