...
namespace Consensus.Finance
{
    ...
    /// </remarks>
    public partial class Payment : Proxy<IPaymentModel, String>
    {
        #region fields
        ...
        /// </summary>
        internal Payment(IPaymentModel model) : base(model)
        {
        }
        ...
        /// </returns>
        public static Consensus.Finance.Payment Create()
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.Create(site);
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAll()
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchAll(site);
        }
        ...
        ///     An enumerable collection of <see cref="!:PaymentModel" /> instances.
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAll(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentModel> collection = provider.Finance.Payment.FetchAll();
        ...
        /// </returns>
        public static Consensus.Finance.Payment FetchById(System.String id)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchById(site,id);
        }
        ...
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.GetTableName(site);
        }

        public static System.String GetTableName(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            return provider.Finance.Payment.GetTableName();
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllBySellingCompanyId(System.String sellingCompanyId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchAllBySellingCompanyId(site,sellingCompanyId);
        }
        ...
        ///     The <see cref="!:PaymentModel" /> instances that match the specified <paramref name="sellingCompanyId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllBySellingCompanyId(ConsensusSite site, System.String sellingCompanyId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentModel> collection = provider.Finance.Payment.FetchAllBySellingCompanyId(sellingCompanyId);
            return collection.Select(model => new Consensus.Finance.Payment(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByMemberPeriodId(System.String memberPeriodId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchAllByMemberPeriodId(site,memberPeriodId);
        }
        ...
        ///     The <see cref="!:PaymentModel" /> instances that match the specified <paramref name="memberPeriodId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByMemberPeriodId(ConsensusSite site, System.String memberPeriodId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentModel> collection = provider.Finance.Payment.FetchAllByMemberPeriodId(memberPeriodId);
            return collection.Select(model => new Consensus.Finance.Payment(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByOrganisationId(System.String organisationId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchAllByOrganisationId(site,organisationId);
        }
        ...
        ///     The <see cref="!:PaymentModel" /> instances that match the specified <paramref name="organisationId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByOrganisationId(ConsensusSite site, System.String organisationId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentModel> collection = provider.Finance.Payment.FetchAllByOrganisationId(organisationId);
            return collection.Select(model => new Consensus.Finance.Payment(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByPersonId(System.String personId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchAllByPersonId(site,personId);
        }
        ...
        ///     The <see cref="!:PaymentModel" /> instances that match the specified <paramref name="personId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByPersonId(ConsensusSite site, System.String personId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentModel> collection = provider.Finance.Payment.FetchAllByPersonId(personId);
            return collection.Select(model => new Consensus.Finance.Payment(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByBookingId(System.String bookingId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchAllByBookingId(site,bookingId);
        }
        ...
        ///     The <see cref="!:PaymentModel" /> instances that match the specified <paramref name="bookingId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByBookingId(ConsensusSite site, System.String bookingId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentModel> collection = provider.Finance.Payment.FetchAllByBookingId(bookingId);
            return collection.Select(model => new Consensus.Finance.Payment(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByRefundId(System.String refundId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchAllByRefundId(site,refundId);
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByAddressId(System.String addressId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchAllByAddressId(site,addressId);
        }
        ...
        ///     The <see cref="!:PaymentModel" /> instances that match the specified <paramref name="addressId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByAddressId(ConsensusSite site, System.String addressId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentModel> collection = provider.Finance.Payment.FetchAllByAddressId(addressId);
            return collection.Select(model => new Consensus.Finance.Payment(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByAccountId(System.String accountId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchAllByAccountId(site,accountId);
        }
        ...
        ///     The <see cref="!:PaymentModel" /> instances that match the specified <paramref name="accountId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByAccountId(ConsensusSite site, System.String accountId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentModel> collection = provider.Finance.Payment.FetchAllByAccountId(accountId);
            return collection.Select(model => new Consensus.Finance.Payment(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByLetterTemplateId(System.String letterTemplateId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchAllByLetterTemplateId(site,letterTemplateId);
        }
        ...
        ///     The <see cref="!:PaymentModel" /> instances that match the specified <paramref name="letterTemplateId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByLetterTemplateId(ConsensusSite site, System.String letterTemplateId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentModel> collection = provider.Finance.Payment.FetchAllByLetterTemplateId(letterTemplateId);
            return collection.Select(model => new Consensus.Finance.Payment(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByCardholderRoleId(System.String cardholderRoleId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return Payment.FetchAllByCardholderRoleId(site,cardholderRoleId);
        }
        ...
        ///     The <see cref="!:PaymentModel" /> instances that match the specified <paramref name="cardholderRoleId" />.
        /// </returns>
        public static IEnumerable<Consensus.Finance.Payment> FetchAllByCardholderRoleId(ConsensusSite site, System.String cardholderRoleId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Finance.IPaymentModel> collection = provider.Finance.Payment.FetchAllByCardholderRoleId(cardholderRoleId);
            return collection.Select(model => new Consensus.Finance.Payment(model));
        }
