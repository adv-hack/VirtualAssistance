...
namespace Consensus.Learning
{
    ...
    /// </remarks>
    public partial class ProductMerchandise : Proxy<IProductMerchandiseModel, String>
    {
        #region fields
        ...
        /// </summary>
        internal ProductMerchandise(IProductMerchandiseModel model) : base(model)
        {
        }
        ...
        /// </returns>
        public static Consensus.Learning.ProductMerchandise Create()
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.Create(site);
        }
        ...
        ///     A newly instantiated <see cref="!:ProductMerchandiseModel" /> instance.
        /// </returns>
        public static Consensus.Learning.ProductMerchandise Create(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            Consensus.Learning.IProductMerchandiseModel model = provider.Learning.ProductMerchandise.Create();
            return model == null ? null : new Consensus.Learning.ProductMerchandise(model);
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAll()
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAll(site);
        }
        ...
        ///     An enumerable collection of <see cref="!:ProductMerchandiseModel" /> instances.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAll(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAll();
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static Consensus.Learning.ProductMerchandise FetchById(System.String id)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchById(site,id);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instance that matches the specified <paramref name="id" />; or null, if no matching instance can be found.
        /// </returns>
        public static Consensus.Learning.ProductMerchandise FetchById(ConsensusSite site, System.String id)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            Consensus.Learning.IProductMerchandiseModel model = provider.Learning.ProductMerchandise.FetchById(id);
            return model == null ? null : new Consensus.Learning.ProductMerchandise(model);
        }
        ...
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.GetTableName(site);
        }

        public static System.String GetTableName(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            return provider.Learning.ProductMerchandise.GetTableName();
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProdDescripId(System.String prodDescripId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByProdDescripId(site,prodDescripId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="prodDescripId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProdDescripId(ConsensusSite site, System.String prodDescripId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByProdDescripId(prodDescripId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProdContentId(System.String prodContentId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByProdContentId(site,prodContentId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="prodContentId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProdContentId(ConsensusSite site, System.String prodContentId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByProdContentId(prodContentId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProdPrereqId(System.String prodPrereqId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByProdPrereqId(site,prodPrereqId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="prodPrereqId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProdPrereqId(ConsensusSite site, System.String prodPrereqId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByProdPrereqId(prodPrereqId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProdObjectiveId(System.String prodObjectiveId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByProdObjectiveId(site,prodObjectiveId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="prodObjectiveId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProdObjectiveId(ConsensusSite site, System.String prodObjectiveId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByProdObjectiveId(prodObjectiveId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProleIdId(System.String proleIdId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByProleIdId(site,proleIdId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="proleIdId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProleIdId(ConsensusSite site, System.String proleIdId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByProleIdId(proleIdId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProductManagerId(System.String productManagerId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByProductManagerId(site,productManagerId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="productManagerId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProductManagerId(ConsensusSite site, System.String productManagerId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByProductManagerId(productManagerId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByBookingTermsId(System.String bookingTermsId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByBookingTermsId(site,bookingTermsId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="bookingTermsId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByBookingTermsId(ConsensusSite site, System.String bookingTermsId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByBookingTermsId(bookingTermsId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByLocationId(System.String locationId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByLocationId(site,locationId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="locationId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByLocationId(ConsensusSite site, System.String locationId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByLocationId(locationId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllBySellingCompanyId(System.String sellingCompanyId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllBySellingCompanyId(site,sellingCompanyId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="sellingCompanyId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllBySellingCompanyId(ConsensusSite site, System.String sellingCompanyId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllBySellingCompanyId(sellingCompanyId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByAuthorPersonId(System.String authorPersonId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByAuthorPersonId(site,authorPersonId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="authorPersonId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByAuthorPersonId(ConsensusSite site, System.String authorPersonId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByAuthorPersonId(authorPersonId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByVenueId(System.String venueId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByVenueId(site,venueId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="venueId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByVenueId(ConsensusSite site, System.String venueId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByVenueId(venueId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }

        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByPaymentScheduleId(System.Nullable<System.Int32> paymentScheduleId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByPaymentScheduleId(site,paymentScheduleId);
        }

        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByPaymentScheduleId(ConsensusSite site, System.Nullable<System.Int32> paymentScheduleId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByPaymentScheduleId(paymentScheduleId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProductTrainingRulesId(System.String productTrainingRulesId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductMerchandise.FetchAllByProductTrainingRulesId(site,productTrainingRulesId);
        }
        ...
        ///     The <see cref="!:ProductMerchandiseModel" /> instances that match the specified <paramref name="productTrainingRulesId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductMerchandise> FetchAllByProductTrainingRulesId(ConsensusSite site, System.String productTrainingRulesId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductMerchandiseModel> collection = provider.Learning.ProductMerchandise.FetchAllByProductTrainingRulesId(productTrainingRulesId);
            return collection.Select(model => new Consensus.Learning.ProductMerchandise(model));
        }
