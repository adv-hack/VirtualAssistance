...
namespace Consensus.Learning
{
    ...
    /// </remarks>
    public partial class ProductCourse : Proxy<IProductCourseModel, String>
    {
        #region fields

        /// <summary>
        ///     The client-consumable proxy collection for the <see cref="ProfileProductCourse" /> member.
        /// </summary>
        private ProxyCollection<Consensus.Common.ProfileCourses, Consensus.Common.IProfileCoursesModel> _profileProductCourse;
        ...
        /// </summary>
        public Collection<Consensus.Common.ProfileCourses> ProfileProductCourse
        {
            get
            {
                if (_profileProductCourse == null)
                    _profileProductCourse = new ProxyCollection<Consensus.Common.ProfileCourses, Consensus.Common.IProfileCoursesModel>(this.Model.ProfileProductCourse, model => new Consensus.Common.ProfileCourses(model));
        ...
        /// </summary>
        internal ProductCourse(IProductCourseModel model) : base(model)
        {
        }
        ...
        /// </returns>
        public static Consensus.Learning.ProductCourse Create()
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.Create(site);
        }
        ...
        ///     A newly instantiated <see cref="!:ProductCourseModel" /> instance.
        /// </returns>
        public static Consensus.Learning.ProductCourse Create(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            Consensus.Learning.IProductCourseModel model = provider.Learning.ProductCourse.Create();
            return model == null ? null : new Consensus.Learning.ProductCourse(model);
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAll()
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAll(site);
        }
        ...
        ///     An enumerable collection of <see cref="!:ProductCourseModel" /> instances.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAll(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAll();
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static Consensus.Learning.ProductCourse FetchById(System.String id)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchById(site,id);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instance that matches the specified <paramref name="id" />; or null, if no matching instance can be found.
        /// </returns>
        public static Consensus.Learning.ProductCourse FetchById(ConsensusSite site, System.String id)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            Consensus.Learning.IProductCourseModel model = provider.Learning.ProductCourse.FetchById(id);
            return model == null ? null : new Consensus.Learning.ProductCourse(model);
        }
        ...
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.GetTableName(site);
        }

        public static System.String GetTableName(ConsensusSite site)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            return provider.Learning.ProductCourse.GetTableName();
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProdDescripId(System.String prodDescripId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByProdDescripId(site,prodDescripId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="prodDescripId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProdDescripId(ConsensusSite site, System.String prodDescripId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByProdDescripId(prodDescripId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProdContentId(System.String prodContentId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByProdContentId(site,prodContentId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="prodContentId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProdContentId(ConsensusSite site, System.String prodContentId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByProdContentId(prodContentId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProdPrereqId(System.String prodPrereqId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByProdPrereqId(site,prodPrereqId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="prodPrereqId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProdPrereqId(ConsensusSite site, System.String prodPrereqId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByProdPrereqId(prodPrereqId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProdObjectiveId(System.String prodObjectiveId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByProdObjectiveId(site,prodObjectiveId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="prodObjectiveId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProdObjectiveId(ConsensusSite site, System.String prodObjectiveId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByProdObjectiveId(prodObjectiveId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProleIdId(System.String proleIdId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByProleIdId(site,proleIdId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="proleIdId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProleIdId(ConsensusSite site, System.String proleIdId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByProleIdId(proleIdId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProductManagerId(System.String productManagerId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByProductManagerId(site,productManagerId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="productManagerId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProductManagerId(ConsensusSite site, System.String productManagerId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByProductManagerId(productManagerId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByBookingTermsId(System.String bookingTermsId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByBookingTermsId(site,bookingTermsId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="bookingTermsId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByBookingTermsId(ConsensusSite site, System.String bookingTermsId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByBookingTermsId(bookingTermsId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByLocationId(System.String locationId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByLocationId(site,locationId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="locationId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByLocationId(ConsensusSite site, System.String locationId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByLocationId(locationId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllBySellingCompanyId(System.String sellingCompanyId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllBySellingCompanyId(site,sellingCompanyId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="sellingCompanyId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllBySellingCompanyId(ConsensusSite site, System.String sellingCompanyId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllBySellingCompanyId(sellingCompanyId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByAuthorPersonId(System.String authorPersonId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByAuthorPersonId(site,authorPersonId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="authorPersonId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByAuthorPersonId(ConsensusSite site, System.String authorPersonId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByAuthorPersonId(authorPersonId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByVenueId(System.String venueId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByVenueId(site,venueId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="venueId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByVenueId(ConsensusSite site, System.String venueId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByVenueId(venueId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }

        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByPaymentScheduleId(System.Nullable<System.Int32> paymentScheduleId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByPaymentScheduleId(site,paymentScheduleId);
        }

        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByPaymentScheduleId(ConsensusSite site, System.Nullable<System.Int32> paymentScheduleId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByPaymentScheduleId(paymentScheduleId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
        ...
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProductTrainingRulesId(System.String productTrainingRulesId)
        {
            ConsensusSite site = ConsensusDomain.Configuration[ConsensusDomain.Configuration.DefaultSite];
            return ProductCourse.FetchAllByProductTrainingRulesId(site,productTrainingRulesId);
        }
        ...
        ///     The <see cref="!:ProductCourseModel" /> instances that match the specified <paramref name="productTrainingRulesId" />.
        /// </returns>
        public static IEnumerable<Consensus.Learning.ProductCourse> FetchAllByProductTrainingRulesId(ConsensusSite site, System.String productTrainingRulesId)
        {
            IBusinessProvider provider = site.GetService<IBusinessProvider>();
            IEnumerable<Consensus.Learning.IProductCourseModel> collection = provider.Learning.ProductCourse.FetchAllByProductTrainingRulesId(productTrainingRulesId);
            return collection.Select(model => new Consensus.Learning.ProductCourse(model));
        }
