...
begin
  insert into dbo.PORTAL_USER(
    ...
    @PA_PU_LOCKED_UNTIL,
    @PA_PU_RESET_CODE,
    @PA_PU_PARTNER_SYS_REF,
    @PA_PU_SECRET_QUEST,
    @PA_PU_SECRET_ANSWER,
    @PA_PU_FIRST_LOGIN,
    @PA_PU_LAST_LOGIN,
    @PA_PU_NO_LOGINS,
    @PA_PU_RESET_VALID_UNTIL,
    @PA_PU_RESET_URL,
    @PA_PU_GUID,
    @PA_PU_AUTH_PROVIDER
  );
    set @PA_PU_ID = @@identity;
end
go
