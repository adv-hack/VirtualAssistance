...
begin
  insert into dbo.PORTAL_SETUP(
    ...
    @PA_PS_LOGO_FILE,
    @PA_PS_DISPLAY_MENU,
    @PA_PS_DISPLAY_HEADER,
    @PA_PS_DISPLAY_FOOTER,
    @PA_PS_COPYRIGHT_MESSAGE,
    @PA_PS_PST_ID,
    @PA_PS_PORTAL_TITLE,
    @PA_PS_START_PMENU_ID,
    @PA_PS_PORTAL_URL,
    @PA_PS_PORTAL_LANG_PREFIX,
    @PA_PS_SESSION_TIMEOUT,
    @PA_PS_SECURE_SITE,
    @PA_PS_DISPLAY_DATE,
    @PA_PS_SINGLE_SIGNON,
    @PA_PS_PRINCIP_ORG_ID,
    @PA_PS_RSS_FEED_TTL,
    @PA_PS_RSS_FEED_CH_DESC,
    @PA_PS_GLB_PMENU_ID,
    @PA_PS_TOP_MENU_HTML,
    @PA_PS_ADDITIONAL_HEADTAGS,
    @PA_PS_BOOTSTRAP,
    @PA_PS_MENUBRAND,
    @PA_PS_FB_APP_ID,
    @PA_PS_HIDE_TOOLBAR_ANONY,
    @PA_PS_MINI_IMAGE,
    @PA_PS_IMPERSONATE_USER,
    @PA_PS_IMPERSONATE_PASSWORD,
    @PA_PS_LOCAL_PATH,
    @PA_PS_GLOBAL_LOGIN_PMENU_ID,
    @PA_PS_MESSAGES_PMENU_ID,
    @PA_PS_PRIMARY_PRODUCT_PMENU_ID,
    @PA_PS_PRIMARY_EVENT_PMENU_ID,
    @PA_PS_GOOGLE_API_KEY,
    @PA_PS_SHOW_BREADCRUMB,
    @PA_PS_SHOW_USER_AVATAR
  );
    set @PA_PS_ID = @@identity;
end
go
