...
begin
  insert into dbo.Master_Club(
    ...
    @PA_MSTC_STOP_FLAG,
    @PA_MSTC_NAMED_USERS,
    @PA_MSTC_CURRENCY_TYPE,
    @PA_MSTC_CEN_ID,
    @PA_MSTC_MEP_ID,
    @PA_MSTC_NAMED_BOOKERS,
    @PA_MSTC_NAME,
    @PA_MSTC_UNIQUE_REF
  );
    set @PA_MSTC_ID = @@identity;
end
go
