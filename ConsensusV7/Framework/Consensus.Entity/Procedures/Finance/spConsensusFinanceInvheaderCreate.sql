...
begin
  insert into dbo.InvHeader(
    ...
    @PA_INV_DELVRY_DATE,
    @PA_INV_ORDER_DATE,
    @PA_INV_CUST_ORDER_NO,
    @PA_INV_DELVRY_ADD,
    @PA_INV_REF,
    @PA_INV_DATE,
    @PA_INV_STATUS,
    @PA_INV_ADD,
    @PA_INV_CREDIT_NTE_REF,
    @PA_INV_CREDIT_NTE_DTE,
    @PA_INV_CREDIT_NTE_STA,
    @PA_INV_NOTES,
    @PA_INV_NET_TOTAL,
    @PA_INV_VAT_TOTAL,
    @PA_INV_GROSS_TOTAL,
    @PA_INV_NET_TOTAL_BC,
    @PA_INV_VAT_TOTAL_BC,
    @PA_INV_GROSS_TOTAL_BC,
    @PA_INV_CURRENCY_TYPE,
    @PA_INV_TYPE,
    @PA_INV_ACCOUNT_TYPE,
    @PA_INV_IN_RESPECT_OF,
    @PA_INV_FOOTER,
    @PA_INV_CREDIT_PERCENT,
    @PA_INV_COURSE_ID,
    @PA_INV_COURSE_NAME,
    @PA_INV_CORS_STRT_DTE,
    @PA_INV_COURSE_END_DTE,
    @PA_INV_CORS_COST_CODE,
    @PA_INV_BOOK_REF,
    @PA_INV_BOOKER,
    @PA_INV_BOOK_ORG_NAME,
    @PA_INV_ADD_MAILSTRING,
    @PA_INV_BK_ORG_CUST_AC,
    @PA_INV_VENUE_ORG_NAME,
    @PA_INV_PENALTY,
    @PA_INV_BOOK_ORG_REGI,
    @PA_INV_PRINT_BOOKER,
    @PA_INV_INV_ORG_NAME,
    @PA_INV_EXTRA_NOTES,
    @PA_INV_BAT_ID,
    ...
    @PA_INV_ACC_MOD_BY,
    @PA_INV_ACC_MOD_DATE,
    @PA_INV_NET_TOTAL_BC2,
    @PA_INV_VAT_TOTAL_BC2,
    @PA_INV_GROSS_TOTAL_BC2,
    @PA_INV_UNPAID_TOTAL_BC2,
    @PA_INV_PRINT_BAT_ID,
    @PA_INV_PERSON_PHONE,
    @PA_INV_ACC_ID,
    @PA_INV_BAT_ERROR,
    @PA_INV_SALES_PROLE_ID,
    @PA_INV_PROLE_ID
  );
    set @PA_INV_ID = @@identity;
end
go
