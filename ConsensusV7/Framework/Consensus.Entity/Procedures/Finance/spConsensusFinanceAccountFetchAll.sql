if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusFinanceAccountFetchAll')
  exec ('create procedure dbo.spConsensusFinanceAccountFetchAll as select 1 as temp')
go
alter procedure dbo.spConsensusFinanceAccountFetchAll as 
begin
  select 
    ACC_ID,
    ACC_LOCK,
