...
begin
  ...
  insert into dbo.Payment(
    ...
    @PA_PAY_EXPY_MONTH,
    @PA_PAY_EXPY_YEAR,
    @PA_PAY_REFUND_PAY_ID,
    @PA_PAY_REFUND_PAY_REF,
    @PA_PAY_TXN_TYPE,
    @PA_PAY_BANKING_REF,
    @PA_PAY_BAT_ID,
    @PA_PAY_BANK_CHG,
    @PA_PAY_BANK_CHG_BC,
    @PA_PAY_BANK_CHG_BC2,
    @PA_PAY_MEP_CRT_BAT_ID,
    @PA_PAY_RECVD_BC2,
    @PA_PAY_UNUSED_VAL_BC2,
    @PA_PAY_COST_CODE,
    @PA_PAY_PURPOSE,
    @PA_PAY_SCHN_ID,
    @PA_PAY_ADD_ID,
    @PA_PAY_REVERSE_RES,
    @PA_PAY_BANK_SORT_CODE,
    @PA_PAY_BANK_ACCOUNT,
    @PA_PAY_ACC_ID,
    @PA_PAY_ACC_TRAN_RET,
    @PA_PAY_EXP_BAT_ID,
    ...
    @PA_PAY_LT_ID,
    @PA_PAY_MSTC_ID,
    @PA_PAY_ORIGINAL_CUSTOMER_ACC,
    @PA_PAY_TOKEN,
    @PA_PAY_VOUCHER_TYPE,
    @PA_PAY_GATEWAY_ACC_ID,
    @PA_PAY_CARDHOLDER_PROLE_ID
  );
end
go
