...
begin
  ...
  insert into dbo.DirectDebit(
    ...
    @PA_DD_CCARD_ISSUE,
    @PA_DD_CCARD_SEC_ID,
    @PA_DD_CCARD_START_MTH,
    @PA_DD_CCARD_START_YR,
    @PA_DD_CCARD_EXPY_MTH,
    @PA_DD_CCARD_EXPY_YR,
    @PA_DD_NOTES,
    @PA_DD_BANK_ORG_ID,
    @PA_DD_BANK_ADD_ID,
    ...
    @PA_DD_TOTAL,
    @PA_DD_STATUS_NOTES,
    @PA_DD_STATUS_LAST_DATE,
    @PA_DD_STATUS_PREVIOUS,
    @PA_DD_NO_OF_INSTALLMENTS,
    @PA_DD_DUE_DATE
  );
end
go
