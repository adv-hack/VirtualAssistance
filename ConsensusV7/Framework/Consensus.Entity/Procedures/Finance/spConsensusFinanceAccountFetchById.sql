if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusFinanceAccountFetchById')
  exec ('create procedure dbo.spConsensusFinanceAccountFetchById as select 1 as temp')
go
alter procedure dbo.spConsensusFinanceAccountFetchById(@PA_ACC_ID varchar(11) = null output) as 
begin
  select 
    ACC_ID,
    ACC_LOCK,
