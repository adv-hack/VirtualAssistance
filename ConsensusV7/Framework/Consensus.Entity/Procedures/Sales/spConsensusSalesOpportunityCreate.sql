...
begin
  insert into dbo.Opportunity(
    ...
    @PA_OPP_QUO_ID,
    @PA_OPP_PROM_ID,
    @PA_OPP_PROLE_ID_SALES,
    @PA_OPP_PROLE_ID_TAKEN,
    @PA_OPP_SCH_ID,
    @PA_OPP_TEXT_ID,
    @PA_OPP_TEXT_ID_HIS,
    @PA_OPP_STATUS,
    ...
    @PA_OPP_PROB_PURCH,
    @PA_OPP_PROB_WIN,
    @PA_OPP_DATE_ROL_START,
    @PA_OPP_PERD_ROLL,
    @PA_OPP_INC_ROLL,
    @PA_OPP_INC_START,
    @PA_OPP_INC_END,
    @PA_OPP_DATE_ROLL_END,
    @PA_OPP_NOTE_ROLL,
    @PA_OPP_ROLL_QTY,
    @PA_OPP_ROLL_COST,
    @PA_OPP_ROLL_RET,
    ...
    @PA_OPP_VAL_SOLD_BC,
    @PA_OPP_QUO_VAL_BC,
    @PA_OPP_PROD_INTEREST,
    @PA_OPP_SM_FORCST_DATE,
    @PA_OPP_SM_VALUE,
    @PA_OPP_SM_VALUE_BC,
    @PA_OPP_PROB_WIN_SM,
    @PA_OPP_CURRENCY_TYPE,
    @PA_OPP_EXEC_CODE,
    @PA_OPP_TYPE_CHAN_DATE,
    @PA_OPP_PURCH_ORD_NO,
    @PA_OPP_SUBSP_PER_FROM,
    @PA_OPP_SUBSRIP_PER_TO,
    @PA_OPP_BASIC_ACT_VAL,
    @PA_OPP_MAT_ACT_VAL,
    @PA_OPP_TOT_ACT_VAL,
    @PA_OPP_BASIC_DISC_VAL,
    @PA_OPP_MAT_DISC_VAL,
    @PA_OPP_TOT_DISC_VAL,
    @PA_OPP_BS_ACT_INV_VAL,
    @PA_OPP_MT_ACT_INV_VAL,
    @PA_OPP_TOT_AT_INV_VAL,
    @PA_OPP_BASIC_ANN_VAL,
    @PA_OPP_MAT_ANNUAL_VAL,
    @PA_OPP_TOT_ANNUAL_VAL,
    @PA_OPP_BSC_ACT_VAL_BC,
    @PA_OPP_MAT_ACT_VAL_BC,
    @PA_OPP_TOT_ACT_VAL_BC,
    @PA_OPP_BSC_DSC_VAL_BC,
    @PA_OPP_MAT_DSC_VAL_BC,
    @PA_OPP_TOT_DSC_VAL_BC,
    @PA_OPP_BC_AT_IN_VL_BC,
    @PA_OPP_MT_AT_IN_VL_BC,
    @PA_OPP_TT_AT_IN_VL_BC,
    @PA_OPP_BSC_ANN_VAL_BC,
    @PA_OPP_MAT_ANN_VAL_BC,
    @PA_OPP_TOT_ANN_VAL_BC,
    @PA_OPP_MEDIUM,
    @PA_OPP_FREQUENCY,
    @PA_OPP_TAILOR_MADE_NO,
    @PA_OPP_DISPATCH_DATE,
    @PA_OPP_DISPTCH_METHOD,
    @PA_OPP_SERVPROD_TEXT,
    @PA_OPP_DATE_ON_PRINT,
    @PA_OPP_PIC_ID,
    @PA_OPP_ORG_ID_USER,
    @PA_OPP_ACT_ID,
    @PA_OPP_USERNUM_1,
    ...
    @PA_OPP_REAS_DELAY,
    @PA_OPP_RATIONALE,
    @PA_OPP_ORIG_ENQUIRY_TYPE,
    @PA_OPP_SEARCH_GROUP,
    @PA_OPP_SY_TYPE
  );
    set @PA_OPP_ID = @@identity;
end
go
