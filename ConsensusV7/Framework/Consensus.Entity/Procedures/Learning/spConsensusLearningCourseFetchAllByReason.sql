if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByReason')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByReason as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByReason(@PA_COURSE_REASON varchar(40) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_REASON = @PA_COURSE_REASON
end
go
