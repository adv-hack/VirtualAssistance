if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByIntnotes')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByIntnotes as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByIntnotes(@PA_COURSE_INT_NOTES varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_INT_NOTES = @PA_COURSE_INT_NOTES
end
go
