if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByDefmethdel')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByDefmethdel as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByDefmethdel(@PA_PROD_DEF_METH_DEL varchar(40) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_DEF_METH_DEL = @PA_PROD_DEF_METH_DEL
end
go
