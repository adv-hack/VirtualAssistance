if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchById')
  exec ('create procedure dbo.spConsensusLearningProductFetchById as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchById(@PA_PROD_ID varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
