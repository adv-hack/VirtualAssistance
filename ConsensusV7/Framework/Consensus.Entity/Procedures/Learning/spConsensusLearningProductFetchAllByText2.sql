if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByText2')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByText2 as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByText2(@PA_PROD_TEXT2 varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_TEXT2 = @PA_PROD_TEXT2
end
go
