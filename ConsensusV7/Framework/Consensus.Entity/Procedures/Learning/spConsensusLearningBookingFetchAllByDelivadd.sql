if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllByDelivadd')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllByDelivadd as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllByDelivadd(@PA_BOOK_DELIV_ADD varchar(11) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_DELIV_ADD = @PA_BOOK_DELIV_ADD
end
go
