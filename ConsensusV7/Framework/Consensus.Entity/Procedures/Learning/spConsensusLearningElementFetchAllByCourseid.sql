if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByCourseid')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByCourseid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByCourseid(@PA_ELEM_COURSE_ID varchar(11) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_COURSE_ID = @PA_ELEM_COURSE_ID
end
go
