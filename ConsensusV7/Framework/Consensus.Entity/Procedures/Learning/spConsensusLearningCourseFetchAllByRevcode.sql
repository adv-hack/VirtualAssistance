if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByRevcode')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByRevcode as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByRevcode(@PA_COURSE_REV_CODE varchar(40) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_REV_CODE = @PA_COURSE_REV_CODE
end
go
