if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByMsremind3')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByMsremind3 as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByMsremind3(@PA_PROD_MS_REMIND3 varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_MS_REMIND3 = @PA_PROD_MS_REMIND3
end
go
