if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByBktid')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByBktid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByBktid(@PA_ELEM_BKT_ID varchar(11) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_BKT_ID = @PA_ELEM_BKT_ID
end
go
