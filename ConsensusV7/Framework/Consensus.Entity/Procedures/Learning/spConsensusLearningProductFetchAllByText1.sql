if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByText1')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByText1 as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByText1(@PA_PROD_TEXT1 varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_TEXT1 = @PA_PROD_TEXT1
end
go
