if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByCodeimage')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByCodeimage as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByCodeimage(@PA_PROD_CODE_IMAGE varchar(40) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_CODE_IMAGE = @PA_PROD_CODE_IMAGE
end
go
