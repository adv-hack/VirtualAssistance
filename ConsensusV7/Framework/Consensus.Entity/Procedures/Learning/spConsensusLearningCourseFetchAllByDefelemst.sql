if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByDefelemst')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByDefelemst as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByDefelemst(@PA_COURSE_DEF_ELEM_ST varchar(20) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_DEF_ELEM_ST = @PA_COURSE_DEF_ELEM_ST
end
go
