if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAll')
  exec ('create procedure dbo.spConsensusLearningElementFetchAll as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAll as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
