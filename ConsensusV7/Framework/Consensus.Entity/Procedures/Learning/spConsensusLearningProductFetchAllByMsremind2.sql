if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByMsremind2')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByMsremind2 as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByMsremind2(@PA_PROD_MS_REMIND2 varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_MS_REMIND2 = @PA_PROD_MS_REMIND2
end
go
