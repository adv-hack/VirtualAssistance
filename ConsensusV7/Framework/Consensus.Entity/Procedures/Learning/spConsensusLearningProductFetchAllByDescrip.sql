if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByDescrip')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByDescrip as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByDescrip(@PA_PROD_DESCRIP varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_DESCRIP = @PA_PROD_DESCRIP
end
go
