if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByDelid')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByDelid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByDelid(@PA_ELEM_DEL_ID varchar(11) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_DEL_ID = @PA_ELEM_DEL_ID
end
go
