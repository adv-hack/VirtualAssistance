if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByProleid')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByProleid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByProleid(@PA_PROD_PROLE_ID varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_PROLE_ID = @PA_PROD_PROLE_ID
end
go
