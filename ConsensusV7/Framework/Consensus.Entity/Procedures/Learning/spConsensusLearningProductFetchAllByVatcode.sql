if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByVatcode')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByVatcode as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByVatcode(@PA_PROD_VAT_CODE varchar(25) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_VAT_CODE = @PA_PROD_VAT_CODE
end
go
