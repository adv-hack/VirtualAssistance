if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAll')
  exec ('create procedure dbo.spConsensusLearningProductFetchAll as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAll as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
