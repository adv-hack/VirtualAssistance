if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByAcadycode')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByAcadycode as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByAcadycode(@PA_COURSE_ACADY_CODE nvarchar(40) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_ACADY_CODE = @PA_COURSE_ACADY_CODE
end
go
