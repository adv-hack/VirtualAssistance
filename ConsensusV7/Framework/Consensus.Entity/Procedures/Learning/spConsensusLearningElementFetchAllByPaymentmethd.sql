if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByPaymentmethd')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByPaymentmethd as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByPaymentmethd(@PA_ELEM_PAYMENT_METHD varchar(50) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_PAYMENT_METHD = @PA_ELEM_PAYMENT_METHD
end
go
