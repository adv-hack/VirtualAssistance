if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByOppid')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByOppid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByOppid(@PA_COURSE_OPP_ID varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_OPP_ID = @PA_COURSE_OPP_ID
end
go
