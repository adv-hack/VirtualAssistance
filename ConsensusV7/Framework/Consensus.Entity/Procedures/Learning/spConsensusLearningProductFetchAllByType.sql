if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByType')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByType as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByType(@PA_PROD_TYPE varchar(40) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
