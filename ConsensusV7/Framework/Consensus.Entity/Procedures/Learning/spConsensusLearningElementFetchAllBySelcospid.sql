if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllBySelcospid')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllBySelcospid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllBySelcospid(@PA_ELEM_SELCO_SP_ID varchar(11) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_SELCO_SP_ID = @PA_ELEM_SELCO_SP_ID
end
go
