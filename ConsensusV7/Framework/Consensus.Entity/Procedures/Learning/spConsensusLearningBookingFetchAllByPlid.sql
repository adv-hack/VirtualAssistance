if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllByPlid')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllByPlid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllByPlid(@PA_BOOK_PL_ID varchar(11) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_PL_ID = @PA_BOOK_PL_ID
end
go
