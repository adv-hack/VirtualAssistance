if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllByOppid')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllByOppid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllByOppid(@PA_BOOK_OPP_ID varchar(11) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_OPP_ID = @PA_BOOK_OPP_ID
end
go
