if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByRoyaltymodel')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByRoyaltymodel as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByRoyaltymodel(@PA_PROD_ROYALTY_MODEL varchar(40) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_ROYALTY_MODEL = @PA_PROD_ROYALTY_MODEL
end
go
