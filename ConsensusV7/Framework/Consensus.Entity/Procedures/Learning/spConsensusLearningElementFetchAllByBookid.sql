if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByBookid')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByBookid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByBookid(@PA_ELEM_BOOK_ID varchar(11) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_BOOK_ID = @PA_ELEM_BOOK_ID
end
go
