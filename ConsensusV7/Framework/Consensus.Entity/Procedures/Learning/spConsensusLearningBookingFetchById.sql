if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchById')
  exec ('create procedure dbo.spConsensusLearningBookingFetchById as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchById(@PA_BOOK_ID varchar(11) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
