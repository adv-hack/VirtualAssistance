if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByGatewayaccid')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByGatewayaccid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByGatewayaccid(@PA_PROD_GATEWAY_ACC_ID varchar(40) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_GATEWAY_ACC_ID = @PA_PROD_GATEWAY_ACC_ID
end
go
