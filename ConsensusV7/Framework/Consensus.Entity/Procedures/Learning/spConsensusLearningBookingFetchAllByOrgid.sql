if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllByOrgid')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllByOrgid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllByOrgid(@PA_BOOK_ORG_ID varchar(11) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_ORG_ID = @PA_BOOK_ORG_ID
end
go
