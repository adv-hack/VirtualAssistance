if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllBySupstatus')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllBySupstatus as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllBySupstatus(@PA_COURSE_SUP_STATUS varchar(50) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_SUP_STATUS = @PA_COURSE_SUP_STATUS
end
go
