if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByProvorgid')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByProvorgid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByProvorgid(@PA_COURSE_PROV_ORG_ID varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_PROV_ORG_ID = @PA_COURSE_PROV_ORG_ID
end
go
