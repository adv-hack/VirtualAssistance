if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByReference')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByReference as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByReference(@PA_PROD_REF varchar(20) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
