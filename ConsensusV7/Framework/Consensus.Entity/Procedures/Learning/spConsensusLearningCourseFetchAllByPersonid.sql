if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByPersonid')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByPersonid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByPersonid(@PA_COURSE_PERSON_ID varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_PERSON_ID = @PA_COURSE_PERSON_ID
end
go
