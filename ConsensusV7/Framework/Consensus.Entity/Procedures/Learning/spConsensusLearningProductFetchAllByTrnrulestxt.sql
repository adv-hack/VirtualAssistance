if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByTrnrulestxt')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByTrnrulestxt as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByTrnrulestxt(@PA_PROD_TRN_RULES_TXT varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_TRN_RULES_TXT = @PA_PROD_TRN_RULES_TXT
end
go
