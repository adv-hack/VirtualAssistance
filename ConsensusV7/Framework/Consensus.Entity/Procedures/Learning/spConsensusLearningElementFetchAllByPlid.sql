if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByPlid')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByPlid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByPlid(@PA_ELEM_PL_ID varchar(11) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_PL_ID = @PA_ELEM_PL_ID
end
go
