if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByProductid')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByProductid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByProductid(@PA_COURSE_PRODUCT_ID varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_PRODUCT_ID = @PA_COURSE_PRODUCT_ID
end
go
