if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByRevcode')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByRevcode as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByRevcode(@PA_ELEM_REV_CODE varchar(40) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_REV_CODE = @PA_ELEM_REV_CODE
end
go
