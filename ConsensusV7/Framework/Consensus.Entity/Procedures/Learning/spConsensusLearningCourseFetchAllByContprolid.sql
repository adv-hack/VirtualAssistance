if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByContprolid')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByContprolid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByContprolid(@PA_COURSE_CONTPROL_ID varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_CONTPROL_ID = @PA_COURSE_CONTPROL_ID
end
go
