if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllByDlvryadd')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllByDlvryadd as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllByDlvryadd(@PA_BOOK_DLVRY_ADD varchar(11) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_DLVRY_ADD = @PA_BOOK_DLVRY_ADD
end
go
