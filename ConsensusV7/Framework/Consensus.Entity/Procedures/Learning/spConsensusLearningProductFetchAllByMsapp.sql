if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByMsapp')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByMsapp as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByMsapp(@PA_PROD_MS_APP varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_MS_APP = @PA_PROD_MS_APP
end
go
