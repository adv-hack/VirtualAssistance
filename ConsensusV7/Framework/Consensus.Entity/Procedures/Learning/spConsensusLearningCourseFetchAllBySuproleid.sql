if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllBySuproleid')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllBySuproleid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllBySuproleid(@PA_COURSE_SUP_ROLE_ID varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_SUP_ROLE_ID = @PA_COURSE_SUP_ROLE_ID
end
go
