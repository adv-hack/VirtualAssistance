if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllByAddid')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllByAddid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllByAddid(@PA_BOOK_ADD_ID varchar(11) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_ADD_ID = @PA_BOOK_ADD_ID
end
go
