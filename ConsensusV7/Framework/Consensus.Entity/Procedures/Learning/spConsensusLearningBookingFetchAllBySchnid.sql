if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllBySchnid')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllBySchnid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllBySchnid(@PA_BOOK_SCHN_ID varchar(11) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_SCHN_ID = @PA_BOOK_SCHN_ID
end
go
