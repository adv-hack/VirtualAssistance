if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByOrgid')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByOrgid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByOrgid(@PA_PROD_ORG_ID varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_ORG_ID = @PA_PROD_ORG_ID
end
go
