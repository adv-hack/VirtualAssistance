if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllBySelcospid')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllBySelcospid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllBySelcospid(@PA_COURSE_SELCO_SP_ID varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_SELCO_SP_ID = @PA_COURSE_SELCO_SP_ID
end
go
