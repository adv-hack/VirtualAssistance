if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByGrade')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByGrade as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByGrade(@PA_ELEM_GRADE varchar(30) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_GRADE = @PA_ELEM_GRADE
end
go
