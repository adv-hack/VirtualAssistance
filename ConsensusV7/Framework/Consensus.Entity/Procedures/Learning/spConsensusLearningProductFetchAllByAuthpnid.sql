if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByAuthpnid')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByAuthpnid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByAuthpnid(@PA_PROD_AUTH_PN_ID varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_AUTH_PN_ID = @PA_PROD_AUTH_PN_ID
end
go
