if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByRevcode')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByRevcode as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByRevcode(@PA_PROD_REV_CODE varchar(40) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_REV_CODE = @PA_PROD_REV_CODE
end
go
