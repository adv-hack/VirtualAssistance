if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByMsnew')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByMsnew as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByMsnew(@PA_PROD_MS_NEW varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_MS_NEW = @PA_PROD_MS_NEW
end
go
