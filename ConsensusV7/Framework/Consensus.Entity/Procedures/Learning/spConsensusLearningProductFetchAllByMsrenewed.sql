if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByMsrenewed')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByMsrenewed as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByMsrenewed(@PA_PROD_MS_RENEWED varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_MS_RENEWED = @PA_PROD_MS_RENEWED
end
go
