if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllByReason')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllByReason as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllByReason(@PA_BOOK_REASON varchar(30) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_REASON = @PA_BOOK_REASON
end
go
