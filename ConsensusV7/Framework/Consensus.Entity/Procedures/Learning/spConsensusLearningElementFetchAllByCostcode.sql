if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByCostcode')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByCostcode as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByCostcode(@PA_ELEM_COST_CODE varchar(40) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_COST_CODE = @PA_ELEM_COST_CODE
end
go
