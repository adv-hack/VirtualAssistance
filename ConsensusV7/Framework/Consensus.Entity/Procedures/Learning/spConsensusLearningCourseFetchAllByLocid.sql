if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByLocid')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByLocid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByLocid(@PA_COURSE_LOC_ID varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_LOC_ID = @PA_COURSE_LOC_ID
end
go
