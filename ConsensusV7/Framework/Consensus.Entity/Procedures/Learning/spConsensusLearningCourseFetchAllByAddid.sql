if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByAddid')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByAddid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByAddid(@PA_COURSE_ADD_ID varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_ADD_ID = @PA_COURSE_ADD_ID
end
go
