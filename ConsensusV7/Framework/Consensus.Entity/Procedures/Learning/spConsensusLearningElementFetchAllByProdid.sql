if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByProdid')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByProdid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByProdid(@PA_ELEM_PROD_ID varchar(11) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_PROD_ID = @PA_ELEM_PROD_ID
end
go
