if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAll')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAll as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAll as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
