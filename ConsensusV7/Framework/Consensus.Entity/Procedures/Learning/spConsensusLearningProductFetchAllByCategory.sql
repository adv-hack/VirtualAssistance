if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByCategory')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByCategory as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByCategory(@PA_PROD_CATEGORY varchar(40) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_CATEGORY = @PA_PROD_CATEGORY
end
go
