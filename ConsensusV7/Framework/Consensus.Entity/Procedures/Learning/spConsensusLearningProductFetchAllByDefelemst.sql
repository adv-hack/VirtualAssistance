if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByDefelemst')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByDefelemst as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByDefelemst(@PA_PROD_DEF_ELEM_ST varchar(20) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_DEF_ELEM_ST = @PA_PROD_DEF_ELEM_ST
end
go
