if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByBktid')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByBktid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByBktid(@PA_PROD_BKT_ID varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_BKT_ID = @PA_PROD_BKT_ID
end
go
