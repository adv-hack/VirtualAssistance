if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByStatus')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByStatus as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByStatus(@PA_COURSE_STATUS varchar(40) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_STATUS = @PA_COURSE_STATUS
end
go
