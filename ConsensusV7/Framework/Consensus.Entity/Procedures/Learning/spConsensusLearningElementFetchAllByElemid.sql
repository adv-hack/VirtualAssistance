if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByElemid')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByElemid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByElemid(@PA_ELEM_ELEM_ID varchar(11) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_ELEM_ID = @PA_ELEM_ELEM_ID
end
go
