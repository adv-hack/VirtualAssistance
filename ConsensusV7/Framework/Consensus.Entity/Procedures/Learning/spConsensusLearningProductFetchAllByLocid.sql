if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByLocid')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByLocid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByLocid(@PA_PROD_LOC_ID varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_LOC_ID = @PA_PROD_LOC_ID
end
go
