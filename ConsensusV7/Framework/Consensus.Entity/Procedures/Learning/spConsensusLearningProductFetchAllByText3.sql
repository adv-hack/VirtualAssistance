if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByText3')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByText3 as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByText3(@PA_PROD_TEXT3 varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_TEXT3 = @PA_PROD_TEXT3
end
go
