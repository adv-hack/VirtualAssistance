if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllByProleid')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllByProleid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllByProleid(@PA_BOOK_PROLE_ID varchar(20) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_PROLE_ID = @PA_BOOK_PROLE_ID
end
go
