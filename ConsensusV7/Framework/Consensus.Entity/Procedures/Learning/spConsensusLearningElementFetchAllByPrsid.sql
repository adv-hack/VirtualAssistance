if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByPrsid')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByPrsid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByPrsid(@PA_ELEM_PRS_ID varchar(11) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_PRS_ID = @PA_ELEM_PRS_ID
end
go
