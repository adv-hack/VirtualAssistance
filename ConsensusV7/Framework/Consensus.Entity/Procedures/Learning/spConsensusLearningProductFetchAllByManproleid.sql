if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByManproleid')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByManproleid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByManproleid(@PA_PROD_MAN_PROLE_ID varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_MAN_PROLE_ID = @PA_PROD_MAN_PROLE_ID
end
go
