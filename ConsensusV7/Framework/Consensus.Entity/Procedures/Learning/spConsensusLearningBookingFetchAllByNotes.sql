if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllByNotes')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllByNotes as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllByNotes(@PA_BOOK_NOTES varchar(11) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_NOTES = @PA_BOOK_NOTES
end
go
