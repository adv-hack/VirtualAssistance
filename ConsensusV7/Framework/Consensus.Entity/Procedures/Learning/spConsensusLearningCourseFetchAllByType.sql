if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByType')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByType as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByType(@PA_COURSE_TYPE varchar(40) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_TYPE = @PA_COURSE_TYPE
end
go
