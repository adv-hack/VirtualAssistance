if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByActid')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByActid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByActid(@PA_ELEM_ACT_ID varchar(11) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_ACT_ID = @PA_ELEM_ACT_ID
end
go
