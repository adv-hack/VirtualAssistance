if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAllByBktid')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAllByBktid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAllByBktid(@PA_COURSE_BKT_ID varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
    ...
    COURSE_CUT_PRD_TIME
  from dbo.Course
  where COURSE_BKT_ID = @PA_COURSE_BKT_ID
end
go
