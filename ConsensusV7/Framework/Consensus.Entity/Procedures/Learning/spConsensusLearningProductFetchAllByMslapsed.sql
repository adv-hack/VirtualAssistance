if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByMslapsed')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByMslapsed as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByMslapsed(@PA_PROD_MS_LAPSED varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_MS_LAPSED = @PA_PROD_MS_LAPSED
end
go
