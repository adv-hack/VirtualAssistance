if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllBySearchgroup')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllBySearchgroup as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllBySearchgroup(@PA_PROD_SEARCH_GROUP varchar(40) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_SEARCH_GROUP = @PA_PROD_SEARCH_GROUP
end
go
