if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllBySxrefid')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllBySxrefid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllBySxrefid(@PA_ELEM_SXREF_ID varchar(11) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_SXREF_ID = @PA_ELEM_SXREF_ID
end
go
