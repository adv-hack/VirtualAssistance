if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchById')
  exec ('create procedure dbo.spConsensusLearningCourseFetchById as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchById(@PA_COURSE_ID varchar(11) = null output) as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
