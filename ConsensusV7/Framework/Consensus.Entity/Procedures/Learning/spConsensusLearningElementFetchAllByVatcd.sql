if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningElementFetchAllByVatcd')
  exec ('create procedure dbo.spConsensusLearningElementFetchAllByVatcd as select 1 as temp')
go
alter procedure dbo.spConsensusLearningElementFetchAllByVatcd(@PA_ELEM_VATCD varchar(25) = null output) as 
begin
  select 
    ELEM_ID,
    ELEM_LOCK,
    ...
    ELEM_CLAIMED
  from dbo.Element
  where ELEM_VATCD = @PA_ELEM_VATCD
end
go
