if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllBySelcospid')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllBySelcospid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllBySelcospid(@PA_PROD_SELCO_SP_ID varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_SELCO_SP_ID = @PA_PROD_SELCO_SP_ID
end
go
