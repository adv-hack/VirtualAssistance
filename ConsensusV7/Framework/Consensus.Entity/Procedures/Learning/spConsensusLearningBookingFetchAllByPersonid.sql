if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllByPersonid')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllByPersonid as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllByPersonid(@PA_BOOK_PERSON_ID varchar(11) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_PERSON_ID = @PA_BOOK_PERSON_ID
end
go
