if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningBookingFetchAllByInvadd')
  exec ('create procedure dbo.spConsensusLearningBookingFetchAllByInvadd as select 1 as temp')
go
alter procedure dbo.spConsensusLearningBookingFetchAllByInvadd(@PA_BOOK_INV_ADD varchar(11) = null output) as 
begin
  select 
    BOOK_ID,
    BOOK_LOCK,
    ...
    BOOK_USERNUM_6
  from dbo.Booking
  where BOOK_INV_ADD = @PA_BOOK_INV_ADD
end
go
