if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByRegbodyid1')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByRegbodyid1 as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByRegbodyid1(@PA_PROD_REG_BODY_ID_1 varchar(40) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_REG_BODY_ID_1 = @PA_PROD_REG_BODY_ID_1
end
go
