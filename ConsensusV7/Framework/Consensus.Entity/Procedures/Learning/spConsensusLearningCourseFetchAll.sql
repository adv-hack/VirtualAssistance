if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningCourseFetchAll')
  exec ('create procedure dbo.spConsensusLearningCourseFetchAll as select 1 as temp')
go
alter procedure dbo.spConsensusLearningCourseFetchAll as 
begin
  select 
    COURSE_ID,
    COURSE_LOCK,
