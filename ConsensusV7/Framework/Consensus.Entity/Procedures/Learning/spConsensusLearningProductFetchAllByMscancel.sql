if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusLearningProductFetchAllByMscancel')
  exec ('create procedure dbo.spConsensusLearningProductFetchAllByMscancel as select 1 as temp')
go
alter procedure dbo.spConsensusLearningProductFetchAllByMscancel(@PA_PROD_MS_CANCEL varchar(11) = null output) as 
begin
  select 
    PROD_ID,
    PROD_LOCK,
    ...
    PROD_GIFTAID
  from dbo.Product
  where PROD_MS_CANCEL = @PA_PROD_MS_CANCEL
end
go
