if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusMarketingPromotionMasterFetchAll')
  exec ('create procedure dbo.spConsensusMarketingPromotionMasterFetchAll as select 1 as temp')
go
alter procedure dbo.spConsensusMarketingPromotionMasterFetchAll as 
begin
  select 
    PM_MST_ID,
    PM_MST_NAME,
