if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusMarketingPromotionFetchAllByMedianame')
  exec ('create procedure dbo.spConsensusMarketingPromotionFetchAllByMedianame as select 1 as temp')
go
alter procedure dbo.spConsensusMarketingPromotionFetchAllByMedianame(@PA_PM_MEDIA_NAME varchar(50) = null output) as 
begin
  select 
    PM_ID,
    PM_CMP_ID,
    ...
    PM_FOLLOW_ON_PM_ID
  from dbo.Promotion
  where PM_MEDIA_NAME = @PA_PM_MEDIA_NAME
end
go
