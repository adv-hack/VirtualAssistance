if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusMarketingCampaignFetchById')
  exec ('create procedure dbo.spConsensusMarketingCampaignFetchById as select 1 as temp')
go
alter procedure dbo.spConsensusMarketingCampaignFetchById(@PA_CMP_ID varchar(11) = null output) as 
begin
  select 
    CMP_ID,
    CMP_NAME,
