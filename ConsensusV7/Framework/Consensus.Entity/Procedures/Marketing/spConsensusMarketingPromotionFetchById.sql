if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusMarketingPromotionFetchById')
  exec ('create procedure dbo.spConsensusMarketingPromotionFetchById as select 1 as temp')
go
alter procedure dbo.spConsensusMarketingPromotionFetchById(@PA_PM_ID varchar(11) = null output) as 
begin
  select 
    PM_ID,
    PM_CMP_ID,
