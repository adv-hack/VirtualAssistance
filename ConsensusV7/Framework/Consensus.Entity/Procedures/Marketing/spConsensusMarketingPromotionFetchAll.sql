if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusMarketingPromotionFetchAll')
  exec ('create procedure dbo.spConsensusMarketingPromotionFetchAll as select 1 as temp')
go
alter procedure dbo.spConsensusMarketingPromotionFetchAll as 
begin
  select 
    PM_ID,
    PM_CMP_ID,
