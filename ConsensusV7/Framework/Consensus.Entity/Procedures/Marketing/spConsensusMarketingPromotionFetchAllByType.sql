if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusMarketingPromotionFetchAllByType')
  exec ('create procedure dbo.spConsensusMarketingPromotionFetchAllByType as select 1 as temp')
go
alter procedure dbo.spConsensusMarketingPromotionFetchAllByType(@PA_PM_TYPE varchar(40) = null output) as 
begin
  select 
    PM_ID,
    PM_CMP_ID,
