if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusMarketingPromotionFetchAllByCmpid')
  exec ('create procedure dbo.spConsensusMarketingPromotionFetchAllByCmpid as select 1 as temp')
go
alter procedure dbo.spConsensusMarketingPromotionFetchAllByCmpid(@PA_PM_CMP_ID varchar(11) = null output) as 
begin
  select 
    PM_ID,
    PM_CMP_ID,
