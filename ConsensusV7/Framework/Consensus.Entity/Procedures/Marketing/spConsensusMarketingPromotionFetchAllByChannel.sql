if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusMarketingPromotionFetchAllByChannel')
  exec ('create procedure dbo.spConsensusMarketingPromotionFetchAllByChannel as select 1 as temp')
go
alter procedure dbo.spConsensusMarketingPromotionFetchAllByChannel(@PA_PM_CHANNEL varchar(15) = null output) as 
begin
  select 
    PM_ID,
    PM_CMP_ID,
    ...
    PM_FOLLOW_ON_PM_ID
  from dbo.Promotion
  where PM_CHANNEL = @PA_PM_CHANNEL
end
go
