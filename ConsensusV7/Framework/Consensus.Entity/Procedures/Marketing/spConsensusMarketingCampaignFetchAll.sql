if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusMarketingCampaignFetchAll')
  exec ('create procedure dbo.spConsensusMarketingCampaignFetchAll as select 1 as temp')
go
alter procedure dbo.spConsensusMarketingCampaignFetchAll as 
begin
  select 
    CMP_ID,
    CMP_NAME,
