if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusMarketingPromotionFetchAllByAppproleid')
  exec ('create procedure dbo.spConsensusMarketingPromotionFetchAllByAppproleid as select 1 as temp')
go
alter procedure dbo.spConsensusMarketingPromotionFetchAllByAppproleid(@PA_PM_APP_PROLE_ID varchar(11) = null output) as 
begin
  select 
    PM_ID,
    PM_CMP_ID,
    ...
    PM_FOLLOW_ON_PM_ID
  from dbo.Promotion
  where PM_APP_PROLE_ID = @PA_PM_APP_PROLE_ID
end
go
