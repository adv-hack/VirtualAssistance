if not exists (select object_id from sys.objects where type = 'P' and name = 'spConsensusMarketingPromotionMasterFetchAllByAppproleid')
  exec ('create procedure dbo.spConsensusMarketingPromotionMasterFetchAllByAppproleid as select 1 as temp')
go
alter procedure dbo.spConsensusMarketingPromotionMasterFetchAllByAppproleid(@PA_PM_MST_APP_PROLE_ID varchar(11) = null output) as 
begin
  select 
    PM_MST_ID,
    PM_MST_NAME,
  ...
  where PM_MST_APP_PROLE_ID = @PA_PM_MST_APP_PROLE_ID
end
go
