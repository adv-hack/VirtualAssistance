...
begin
  insert into dbo.Member_location(
    ...
    @PA_MEL_GROSS_FEE,
    @PA_MEL_GROSS_FEE_BC,
    @PA_MEL_GROSS_FEE_BC2,
    @PA_MEL_DISC_REASON,
    @PA_MEL_PHONE_OVERRIDE,
    @PA_MEL_FAX_OVERRIDE,
    @PA_MEL_PHONE_STD_OVERRIDE,
    @PA_MEL_FAX_STD_OVERRIDE,
    @PA_MEL_EMAIL_OVERRIDE,
    @PA_MEL_URL,
    @PA_MEL_FEE_NOT_PRO_RATA,
    @PA_MEL_WEB_ENABLED,
    @PA_MEL_FEE_EXEMPT,
    @PA_MEL_CURRENT_DATE,
    @PA_MEL_CANCEL_DATE,
    ...
    @PA_MEL_DISCOUNT_BC,
    @PA_MEL_DISCOUNT_BC2,
    @PA_MEL_DISC_APPLIED_DATE,
    @PA_MEL_FEE_CALCULATED,
    @PA_MEL_LIST_PRICE,
    @PA_MEL_LIST_PRICE_BC,
    @PA_MEL_LIST_PRICE_BC2,
    @PA_MEL_DESPATCH_DATE,
    @PA_MEL_PO_NUMBER,
    @PA_MEL_QTY,
    @PA_MEL_DO_NOT_RENEW,
    @PA_MEL_CANCEL_REASON,
    @PA_MEL_UNT_PRICE,
    @PA_MEL_UNT_PRICE_BC,
    @PA_MEL_UNT_PRICE_BC2,
    @PA_MEL_DISC_RENEWAL,
    @PA_MEL_PRICE_MODIFIED,
    @PA_MEL_DISC_PERCENT,
    @PA_MEL_REV_CODE,
    @PA_MEL_COST_CODE
  );
    set @PA_MEL_ID = @@identity;
end
go
