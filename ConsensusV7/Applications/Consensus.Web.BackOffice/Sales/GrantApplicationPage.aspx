<%@ Page Title="" Language="C#" MasterPageFile="~/assets/templates/StandardDetail.master" AutoEventWireup="true" CodeBehind="GrantApplicationPage.aspx.cs" Inherits="Consensus.Web.BackOffice.Sales.GrantApplicationPage" %>
<%@ Register TagPrefix="con" TagName="GrantApplicationDetail" Src="~/sales/controls/OpportunityGrantApplicationDetail.ascx" %>
    ...
    <con:TabControl runat="server">
        <Pages>
            <con:TabPage runat="server" Title="Overview">
                <con:GrantApplicationDetail runat="server" id="GrantApplicationDetail" />
            </con:TabPage>
        </Pages>
    </con:TabControl>
</asp:Content>
