...
{
    public partial class OpportunityDetail : BaseControl<Opportunity, String>
    {
        ...
        {
            this.OpportunityTypeId.FieldValue = Convert.ToString(OpportunitySyType.Opportunity);
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (this.DataSource.Id == null)
            {
                ...
                this.OpportunityTypeId.FieldValue = Convert.ToInt32(OpportunitySyType.Opportunity).ToString();
            }
