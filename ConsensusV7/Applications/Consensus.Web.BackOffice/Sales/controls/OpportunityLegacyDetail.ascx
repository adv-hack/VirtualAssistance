<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpportunityLegacyDetail.ascx.cs" Inherits="Consensus.Web.BackOffice.sales.controls.OpportunityLegacyDetail" %>
<div class="row">
    <div class="col-md-6"> 
        <con:GroupBox runat="server" Title="Legacy details">  
            <con:HiddenField runat="server" ID="OpportunityTypeId" DataBoundValue="SyType"/>         
          <div class="row">
              <div class="col-md-12"><con:TextField runat="server" ID="Name" DataBoundValue="Name" LabelText="Legacy name" Requirement="MandatoryEnforced" /></div>
          </div>
          <div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="Status" DataBoundValue="StatusCode" LabelText="Status" CodeType="LGSTA" Requirement="MandatoryEnforced" /></div>
             <div class="col-md-6"><con:CodeField runat="server" ID="Service" DataBoundValue="ServiceCode" LabelText="Bequest type" CodeType="LGSVR"  /></div>               
          </div>
          <div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="ProductInt" DataBoundValue="ProdInterestCode" LabelText="Bequest category" CodeType="LGGRP"  /></div>
             <div class="col-md-6"><con:CodeField runat="server" ID="Competition" DataBoundValue="CompetitorCode" LabelText="Main beneficiary" CodeType="LGCMP"  /></div>
             <%--<div class="col-md-6"><con:CodeField runat="server" ID="SalesType" DataBoundValue="SalesTypeCode" LabelText="Categorisation 1" CodeType="LGTYP"  /></div>--%>               
          </div>          
          <%-- <div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="Source" DataBoundValue="SourceCode" LabelText="Categorisation 2" CodeType="LGSOU"  /></div>
             <div class="col-md-6"><con:CodeField runat="server" ID="SearchGroup" DataBoundValue="SearchGroupCode" LabelText="Categorisation 3" CodeType="LGMED"  /></div>               
          </div>  --%>       
           <div class="row">
        ...
        <con:GroupBox runat="server" Title="Links">
          <div class="row">
             ...
             <div class="col-md-6"><con:PopupField runat="server" ID="Event" DataBoundValue="CourseIdId" LabelText="Legacy event" PopupUrl="~/learning/popups/eventsearch.aspx" HyperlinkUrl="~/learning/eventpage.aspx?id={id}"/></div>               
              <div class="col-md-6"><con:PopupField runat="server" ID="Promotion" DataBoundValue="PromIdId" LabelText="Source code" PopupUrl="~/marketing/popups/promotionsearch.aspx" HyperlinkUrl="~/marketing/sourcepage.aspx?id={id}"/></div>    
          </div>
          <div class="row">
              <div class="col-md-6">
                <con:ListField runat="server" ID="CostCode" DataBoundValue="CostCode" LabelText="Fund code" ValueMember="Code" DisplayMember="Desc"/>     
          </div>         
          </div>
        </con:GroupBox>
    </div>
    ...
    <div class="col-md-6">
        <con:GroupBox runat="server" Title="Contact information">
          ...
          <div class="row">
            <div class="col-md-6">
                <con:PopupField runat="server" ID="Client" DataBoundValue="ClientOppXref.RoleId" LabelText="Lead Solicitor" PopupUrl="~/crm/popups/personsearch.aspx" HyperlinkUrl="~/crm/personpage.aspx?role={id}" Requirement="MandatoryEnforced">
                     <Filters>
          ...
          <div class="row">
            ...
            <div class="col-md-6"><con:PopupField runat="server" ID="SalesPerson" DataBoundValue="SalesOppXref.RoleId" LabelText="Legacy Manager" PopupUrl="~/crm/popups/personsearch.aspx" HyperlinkUrl="~/crm/personpage.aspx?role={id}" /></div>      
          </div>
         ...
         <%-- <con:HiddenField runat="server" ID="OwnerOrganisationId" DataBoundValue="SalesOppXref.OrganisationId" />
          <con:HiddenField runat="server" ID="OwnerOrganisationName" DataBoundValue="SalesOppXref.OrgName" />--%>
        </con:GroupBox>
        
        <con:GroupBox runat="server" Title="Forecast">
          <div class="row">
            <div class="col-md-6"><con:DateField runat="server" ID="DateOfEnquiry" DataBoundValue="DateEnq" LabelText="Date of Death" /></div>
            <div class="col-md-6"><con:DateField runat="server" ID="DecisionDate" DataBoundValue="DateDec" LabelText="Date of Probate" /></div>
          </div>
          <div class="row">
            <div class="col-md-6"><con:TextField runat="server" ID="ProbPurchase" DataBoundValue="ProbPurch" LabelText="Proportion of Estate" TextMode="Number" /></div>
            <div class="col-md-6"><con:TextField runat="server" ID="Quantity" DataBoundValue="RollQty" LabelText="Value of Estate" TextMode="Number"/></div>
          ...
          <div class="row">
            <div class="col-md-6"><con:TextField runat="server" ID="ContractValue" DataBoundValue="ValPot" LabelText="Value of Bequest" TextMode="Number"/></div>
            <div class="col-md-6"><con:CheckField runat="server" ID="CommittedToForecast" DataBoundValue="Commit"  LabelText="Probate Complete" /></div>
          </div>
