<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpportunityGrantApplicationDetail.ascx.cs" Inherits="Consensus.Web.BackOffice.sales.controls.OpportunityGrantApplicationDetail" %>
<div class="row">
    <div class="col-md-6"> 
        <con:GroupBox runat="server" Title="Grant application details">  
            <con:HiddenField runat="server" ID="OpportunityTypeId" DataBoundValue="SyType"/>         
          <div class="row">
              <div class="col-md-12"><con:TextField runat="server" ID="Name" DataBoundValue="Name" LabelText="Grant name" Requirement="MandatoryEnforced" /></div>
          </div>
          <div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="Status" DataBoundValue="StatusCode" LabelText="Status" CodeType="GASTA" Requirement="MandatoryEnforced" /></div>
             <div class="col-md-6"><con:CodeField runat="server" ID="Service" DataBoundValue="ServiceCode" LabelText="Awarding body type" CodeType="GASVR"  /></div>               
          </div>
          <div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="ProductInt" DataBoundValue="ProdInterestCode" LabelText="Main interest" CodeType="GAGRP"  /></div>
             ...
             <%--<div class="col-md-6"><con:CodeField runat="server" ID="SalesType" DataBoundValue="SalesTypeCode" LabelText="Categorisation 1" CodeType="GATYP" /></div>  --%>             
          </div>          
           <%--<div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="Source" DataBoundValue="SourceCode" LabelText="Categorisation 2" CodeType="GASOU" /></div>
             <div class="col-md-6"><con:CodeField runat="server" ID="SearchGroup" DataBoundValue="SearchGroupCode" LabelText="Categorisation 3" CodeType="GAMED" /></div>               
          </div>  --%>       
           <%--<div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="Competition" DataBoundValue="CompetitorCode" LabelText="Competition" CodeType="GACMP"/></div>
    ...
    <div class="col-md-6">
        <con:GroupBox runat="server" Title="Contact information">
          ...
          <div class="row">
            ...
            <div class="col-md-6"><con:PopupField runat="server" ID="SalesPerson" DataBoundValue="SalesOppXref.RoleId" LabelText="Application owner" PopupUrl="~/crm/popups/personsearch.aspx" HyperlinkUrl="~/crm/personpage.aspx?role={id}" /></div>      
          </div>
        ...
        <con:GroupBox runat="server" Title="Forecast">
          <div class="row">
            <div class="col-md-6"><con:DateField runat="server" ID="DateOfEnquiry" DataBoundValue="DateEnq" LabelText="Application deadline" /></div>
          ...
          <div class="row">
            ...
            <div class="col-md-6"><con:TextField runat="server" ID="Quantity" DataBoundValue="RollQty" LabelText="Number of installments" TextMode="Number"/></div>
          ...
          <div class="row">
            ...
            <div class="col-md-6"><con:CheckField runat="server" ID="CommittedToForecast" DataBoundValue="Commit"  LabelText="Award confirmed" /></div>
          </div> 
        </con:GroupBox>
    </div>
</div>
