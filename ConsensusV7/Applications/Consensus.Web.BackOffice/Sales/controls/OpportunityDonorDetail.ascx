<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpportunityDonorDetail.ascx.cs" Inherits="Consensus.Web.BackOffice.sales.controls.OpportunityDonorDetail" %>
<div class="row">
    <div class="col-md-6"> 
        <con:GroupBox runat="server" Title="Major donor details">  
            <con:HiddenField runat="server" ID="OpportunityTypeId" DataBoundValue="SyType"/>         
          <div class="row">
              <div class="col-md-12"><con:TextField runat="server" ID="Name" DataBoundValue="Name" LabelText="Donor name" Requirement="MandatoryEnforced" /></div>
          </div>
          <div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="Status" DataBoundValue="StatusCode" LabelText="Status" CodeType="MDSTA" Requirement="MandatoryEnforced" /></div>
             <div class="col-md-6"><con:CodeField runat="server" ID="Service" DataBoundValue="ServiceCode" LabelText="Donor type" CodeType="MDSVR"  /></div>               
          </div>
          <div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="ProductInt" DataBoundValue="ProdInterestCode" LabelText="Main interest" CodeType="MDGRP"  /></div>
              <div class="col-md-6"><con:CodeField runat="server" ID="SearchGroup" DataBoundValue="SearchGroupCode" LabelText="Gift type" CodeType="MDMED"  /></div>  
             <%--<div class="col-md-6"><con:CodeField runat="server" ID="SalesType" DataBoundValue="SalesTypeCode" LabelText="Categorisation 1" CodeType="MDTYP"  /></div>--%>               
          </div>          
          <%-- <div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="Source" DataBoundValue="SourceCode" LabelText="Categorisation 2" CodeType="MDSOU"  /></div>
                          
          </div>   --%>      
           <div class="row">
             <%--<div class="col-md-6"><con:CodeField runat="server" ID="Competition" DataBoundValue="CompetitorCode" LabelText="Competition" CodeType="MDCMP"  /></div>--%>
    ...
    <div class="col-md-6">
        ...
        <con:GroupBox runat="server" Title="Forecast">
          <div class="row">
            ...
            <div class="col-md-6"><con:DateField runat="server" ID="DecisionDate" DataBoundValue="DateDec" LabelText="Invoice date" /></div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-6"><con:TextField runat="server" ID="ContractValue" DataBoundValue="ValPot" LabelText="Total Value of gift" TextMode="Number"/></div>
            <div class="col-md-6"><con:CheckField runat="server" ID="CommittedToForecast" DataBoundValue="Commit"  LabelText="Gift Confirmed" /></div>
          </div>
