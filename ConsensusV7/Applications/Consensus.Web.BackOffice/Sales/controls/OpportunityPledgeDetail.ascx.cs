...
{
    public partial class OpportunityPledgeDetail : BaseControl<Opportunity, String>
    {
        ...
        protected override void PopulateControl()
        {
            ...
            this.OpportunityTypeId.FieldValue = Convert.ToInt32(OpportunitySyType.Pledges).ToString();
