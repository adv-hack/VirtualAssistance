...
{
    public partial class OpportunityLegacyDetail : BaseControl<Opportunity, String>
    {
        ...
        protected override void PopulateControl()
        {
            ...
            this.OpportunityTypeId.FieldValue = Convert.ToInt32(OpportunitySyType.Legacies).ToString();
