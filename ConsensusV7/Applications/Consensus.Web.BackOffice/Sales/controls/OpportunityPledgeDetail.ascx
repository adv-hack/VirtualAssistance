<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpportunityPledgeDetail.ascx.cs" Inherits="Consensus.Web.BackOffice.sales.controls.OpportunityPledgeDetail" %>
<div class="row">
    <div class="col-md-6"> 
        <con:GroupBox runat="server" Title="Pledge details">  
            <con:HiddenField runat="server" ID="OpportunityTypeId" DataBoundValue="SyType"/>         
          <div class="row">
              <div class="col-md-12"><con:TextField runat="server" ID="Name" DataBoundValue="Name" LabelText="Pledge name" Requirement="MandatoryEnforced" /></div>
          </div>
          <div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="Status" DataBoundValue="StatusCode" LabelText="Pledge status" CodeType="PLSTA" Requirement="MandatoryEnforced" /></div>
             <div class="col-md-6"><con:CodeField runat="server" ID="Service" DataBoundValue="ServiceCode" LabelText="Pledge type" CodeType="PLSVR"  /></div>               
          </div>
          <%--<div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="ProductInt" DataBoundValue="ProdInterestCode" LabelText="Group" CodeType="PLGRP"  /></div>
             <div class="col-md-6"><con:CodeField runat="server" ID="SalesType" DataBoundValue="SalesTypeCode" LabelText="Categorisation 1" CodeType="PLTYP"  /></div>               
          </div>          
           <div class="row">
             <div class="col-md-6"><con:CodeField runat="server" ID="Source" DataBoundValue="SourceCode" LabelText="Categorisation 2" CodeType="PLSOU"  /></div>
             <div class="col-md-6"><con:CodeField runat="server" ID="SearchGroup" DataBoundValue="SearchGroupCode" LabelText="Categorisation 3" CodeType="PLMED"  /></div>               
          </div> --%>        
           <div class="row">
             <%--<div class="col-md-6"><con:CodeField runat="server" ID="Competition" DataBoundValue="CompetitorCode" LabelText="Competition" CodeType="PLCMP"  /></div>--%>
        ...
        <con:GroupBox runat="server" Title="Links">
          <div class="row">
             ...
             <div class="col-md-6"><con:PopupField runat="server" ID="Event" DataBoundValue="CourseIdId" LabelText="Related event" PopupUrl="~/learning/popups/eventsearch.aspx" HyperlinkUrl="~/learning/eventpage.aspx?id={id}"/></div>  
    ...
    <div class="col-md-6">
        <con:GroupBox runat="server" Title="Contact information">
          ...
          <div class="row">
            <div class="col-md-6">
                <con:PopupField runat="server" ID="Client" DataBoundValue="ClientOppXref.RoleId" LabelText="Pledger" PopupUrl="~/crm/popups/personsearch.aspx" HyperlinkUrl="~/crm/personpage.aspx?role={id}" Requirement="MandatoryEnforced" >
                     <Filters>
          ...
          <div class="row">
            ...
            <div class="col-md-6"><con:PopupField runat="server" ID="SalesPerson" DataBoundValue="SalesOppXref.RoleId" LabelText="Relationship owner" PopupUrl="~/crm/popups/personsearch.aspx" HyperlinkUrl="~/crm/personpage.aspx?role={id}" /></div>      
          </div>
        ...
        <con:GroupBox runat="server" Title="Forecast">
          <div class="row">
            <div class="col-md-6"><con:DateField runat="server" ID="DateOfEnquiry" DataBoundValue="DateEnq" LabelText="Pledge Date" /></div>
            <div class="col-md-6"><con:DateField runat="server" ID="DecisionDate" DataBoundValue="DateDec" LabelText="First Payment Due date" /></div>
          </div>
          <%--<div class="row">
          ...
          <div class="row">
            <div class="col-md-6"><con:TextField runat="server" ID="Quantity" DataBoundValue="RollQty" LabelText="Number of instalments" TextMode="Number"/></div>
            <div class="col-md-6"><con:TextField runat="server" ID="ContractValue" DataBoundValue="ValPot" LabelText="Total Value of Pledge" TextMode="Number"/></div>
          </div>
          <%--<div class="row">
