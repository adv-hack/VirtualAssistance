...
{
    public partial class LegacyPage : BaseStandardPage<Opportunity, String>
    {
        #region properties
        ...
        {
            get { return "Legacy - " + this.Data.Name; }
        }
        ...
        protected override void PopulateControls()
        {
            ...
            this.Data.SyType = Convert.ToInt32(OpportunitySyType.Legacies);
            Opportunity legacyOpportunity = this.Data;
            this.OpportunityLegacyDetail.DataSource = legacyOpportunity;
            ...
            this.DiaryList.OppSyType = OpportunitySyType.Legacies;
