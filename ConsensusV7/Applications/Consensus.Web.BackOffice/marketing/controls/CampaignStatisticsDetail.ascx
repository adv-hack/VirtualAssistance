<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CampaignStatisticsDetail.ascx.cs" Inherits="Consensus.Web.BackOffice.marketing.controls.CampaignStatisticsDetail" %>
<div class="row">
    <div class="col-md-6">
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <con:GroupBox runat="server" Title="Target">                                                                         
                        <div class="col-md-12">
                            <con:TextField runat="server" ID="BudgetCosts" DataBoundValue="BudgetCosts" TextMode="Number" ClientOnChange="changedBudgetCost();" />
                        </div>
                        <div class="col-md-12">
                            <con:TextField runat="server" ID="TotalBudgetCosts" TextMode="Number" IsReadonly="True" />
                        </div>                        
                         <div class="col-md-12">
                            <con:TextField runat="server" ID="CalculatedBudgetCosts" TextMode="Number" IsReadonly="True"/>
                        </div> 
                        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <con:GroupBox runat="server" Title="Actual">                                                                        
                        <div class="col-md-12">
                            <con:TextField runat="server" ID="ActualCosts" DataBoundValue="ActualCosts" TextMode="Number" ClientOnChange="changedActualCost();" />
                        </div>
                        <div class="col-md-12">
                            <con:TextField runat="server" ID="TotalActualCosts" TextMode="Number" IsReadonly="True"/>
                        </div>                       
                        <div class="col-md-12">
                            <con:TextField runat="server" ID="CalculatedActualCosts" TextMode="Number" IsReadonly="True"/>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <con:TextField runat="server" ID="ActualBookingsValue" TextMode="Number" IsReadonly="True" />
                        </div>  
                        <div class="col-md-12">
