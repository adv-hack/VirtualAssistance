 ...
 * 
 * NOTE: Changed by OJH for V1/Advanced to get layout to work in Consensus/Cloud Donor 16/05/18
 *  See line 5824
 * 
 */
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.followScroll = function () {
        ...
        var toolbarHeight = this.$toolbar.outerHeight(); // OJH 16/05/18 height();
        $toolbarWrapper.css({
    ...
    Toolbar.prototype.changeContainer = function (isFullscreen) {
		// OJH 29-03-2018 Don't move the toolbar from the default container unless toobarContainer is set.
		// This is a V1/Advanced fix, not in the standard product (though it should be).
        if (this.options.toolbarContainer) {
            if (isFullscreen) {
