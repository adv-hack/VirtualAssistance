<%@ Page Title="" Language="C#" MasterPageFile="~/assets/templates/StandardDetail.master" AutoEventWireup="true" CodeBehind="ProductPage.aspx.cs" Inherits="Consensus.Web.BackOffice.learning.ProductPage" %>
<%@ Register TagPrefix="con" TagName="ProductDetails" Src="~/learning/controls/productdetails.ascx" %>
