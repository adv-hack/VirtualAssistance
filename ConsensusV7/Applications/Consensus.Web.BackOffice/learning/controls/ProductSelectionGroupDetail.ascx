<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductSelectionGroupDetail.ascx.cs" Inherits="Consensus.Web.BackOffice.learning.controls.ProductSelectionGroupDetail" %>
