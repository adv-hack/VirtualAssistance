<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MembershipInvoiceList.ascx.cs" Inherits="Consensus.Web.BackOffice.membership.controls.MembershipInvoiceList" %>
<con:DataTable runat="server" ID="MemberInvoices" Mode="Redirect" Url="~/finance/invoicepage.aspx?id={{Id}}" CanCreate="false">
  <Columns>
