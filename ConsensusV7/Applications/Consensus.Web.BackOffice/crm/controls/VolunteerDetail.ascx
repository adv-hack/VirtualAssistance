<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VolunteerDetail.ascx.cs" Inherits="Consensus.Web.BackOffice.crm.controls.VolunteerDetail" %>

<div class="row">
    <div class="col-md-6">
        <con:GroupBox runat="server" Title="Volunteer details">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <con:CodeField runat="server" ID="Status" DataBoundValue="StatusCode" LabelText="Status" CodeType="VRSTA" Requirement="MandatoryEnforced" />
                </div>
                <div class="col-md-6">
    ...
    <div class="col-md-6">
        <con:GroupBox runat="server" Title="Volunteer information">
            <div class="row">
                <div class="col-md-6">
                    <con:TextField runat="server" ID="Reference" DataBoundValue="AinRef" LabelText="Reference" />
                </div>
                <div class="col-md-6">
                    <con:CodeField runat="server" ID="Type" DataBoundValue="Attribute01Code" LabelText="Type" CodeType="VRAN1" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <con:TextField runat="server" ID="DayCost" TextMode="Number" DataBoundValue="AinDayCost" LabelText="Daily cost">                        
                    </con:TextField>
                </div>
                <div class="col-md-6">
                    <con:TextField runat="server" ID="HourCost" TextMode="Number" DataBoundValue="AinHourCost" LabelText="Hourly cost">                       
                    </con:TextField>
                </div>
            </div>
        </con:GroupBox>
        ...
        if( $('#<%= this.Name.ClientID %>Value').val()){
            consensus.network.send({
                ...
                success: function (response) {
                    if (response) {
                        swal({ title: 'Error', text: 'This person is already a volunteer.', type: 'error', showCancelButton: false, confirmButtonText: 'Ok', confirmButtonClass: 'btn btn-danger', buttonsStyling: false }).then(function (success) {
